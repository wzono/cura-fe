(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{"+8Ar":function(e,t,n){"use strict"
var r=n("+aGp"),a=/^ms-/
e.exports=function(e){return r(e).replace(a,"-ms-")}},"+Cau":function(e,t,n){"use strict"
var r=n("TqRt")
...
return{getState:t,dispatch:n,state:r,project:i,isHighlight:a}}},"+aGp":function(e,t,n){"use strict"
var r=/([A-Z])/g
e.exports=function(e){return e.replace(r,"-$1").toLowerCase()}},"+c4W":function(e,t,n){var r=n("711d"),a=n("4/ic"),o=n("9ggG"),i=n("9Nap")
...
var a=r(n("MVZn")),o={isOpen:!1,type:"alert",alertType:"alert",title:"",desc:"",onClose:function(){return null},onCancel:null,onConfirm:null,cancelText:void 0,confirmText:void 0,canCancel:!0,canConfirm:!0,canClose:!0}},"0/XF":function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
return v===u&&g===l&&b===d&&y===s||((n=u-v)&&h.forEach(function(e){e.top-=Math.round(n/2*(0,w.sin)(o)),e.left+=Math.round(n/2-n/2*(0,w.cos)(o))}),(r=l-g)&&h.forEach(function(e){e.left+=Math.round(r/2*(0,w.sin)(o)),e.top+=Math.round(r/2-r/2*(0,w.cos)(o))}),(r=y-s)&&h.forEach(function(e){e.left-=Math.round(r/2*(0,w.sin)(o)),e.top-=Math.round(r/2-r/2*(0,w.cos)(o))}),(n=b-d)&&h.forEach(function(e){e.top+=Math.round(n/2*(0,w.sin)(o)),e.left-=Math.round(n/2-n/2*(0,w.cos)(o))})),h}return e}},"0uCA":function(e,t,n
){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(n("lwsE")),a=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),l=r(n("7W2i")),s=r(n("PJYZ")),d=r(n("lSNA")),f=r(n("q1tI")),o=r(n("17x9")),p=n("1qiG"),h=function(e){function o(){var e,a;(0,i.default)(this,o)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return a=(0,c.default)(this,(e=(0,u.default)(o)).call.apply(e,[this].concat(n))),(0,d.default)((0,s.default)((0,s.default)(a)),"genLines",function(e,t){var n=a.props.style,r=[]
...
Object.defineProperty(t,"__esModule",{value:!0}),t.toPercentage=t.getDistancesForDirections=t.getMinContainingRect=t.checkSameRect=void 0
t.checkSameRect=function(t,n){return["top","left","width","height"].every(function(e){return t[e]===n[e]})}
var u=function(e,t){var n=Math.min(e.top||0,t.top||0),r=Math.max((e.top||0)+e.height,(t.top||0)+t.height),a=Math.min(e.left||0,t.left||0)
return{top:n,left:a,width:Math.max((e.left||0)+e.width,(t.left||0)+t.width)-a,height:r-n}}
t.getMinContainingRect=u
t.getDistancesForDirections=function(e,t){if((a=u(n=e,r=t)).width<n.width+r.width&&a.height<n.height+r.height)return{top:e.top-t.top,right:t.left+t.width-(e.left+e.width),bottom:t.top+t.height-(e.top+e.height),left:e.left-t.left}
var n,r,a,o={},i=function(e,t){var n=[],r=u(e,t)
...
else{var i=r.height-(e.height+t.height),c=t.top>e.top
n[1]=c?i:-i}return n}(e,t)
return 0<i[0]?o.right=i[0]:i[0]<0&&(o.left=Math.abs(i[0])),0<i[1]?o.bottom=i[1]:i[1]<0&&(o.top=Math.abs(i[1])),o}
...
if(o.height>a.height||o.width>a.width)return!0}return!1}},l=(0,i.default)({},u,{probeType:3,scrollbars:!0,mouseWheel:!0,disableMouse:!1,interactiveScrollbars:!0,shrinkScrollbars:"scale",fadeScrollbars:!0,HWCompositing:!1}),s=function(){function e(){(0,a.default)(this,e),this.iScrollMap={}}return(0,o.default)(e,[{key:"clear",value:function(){this.destroyScrollBar()}},{key:"setObjectUrl",value:function(e,t){e&&(e.contentWindow?e.contentWindow.location.replace(t):e.setAttribute("src",t))}},{key:"deviceOrient",
value:function(){return $(window).width()>$(window).height()?"landscape":"portrait"}},{key:"initScrollBar",value:function(e){if(!this.iScrollMap[e]){var n=document.querySelector("#pscreen".concat(e," .screen-content"))
...
t.default=s},"2q7i":function(e,t,n){e.exports=function c(e){"use strict"
var P=/^\0+/g,j=/[\0\r\f]/g,u=/: */g,l=/zoo|gra/,s=/([,: ])(transform)/g,d=/,+\s*(?![^(]*[)])/g,f=/ +\s*(?![^(]*[)])/g,L=/ *[\0] */g,p=/,\r+?/g,i=/([\t\r\n ])*\f?&/g,h=/:global\(((?:[^\(\)\[\]]*|\[.*\]|\([^\(\)]*\))*)\)/g,m=/\W+/g,D=/@(k\w+)\s*(\S*)\s*/,B=/::(place)/g,F=/:(read-only)/g,v=/\s+(?=[{\];=:>])/g,g=/([[}=:>])\s+/g,y=/(\{[^{]+?);(?=\})/g,b=/\s{2,}/g,U=/([^\(])(:+) */g,w=/[svh]\w+-[tblr]{2}/,q=/\(\s*(.*)\s*\)/g,r=/([\s\S]*?);/g,S=/-self|flex-/g,o=/[^]*?(:[rp][el]a[\w-]+)[^]*/,
E=/stretch|:\s*\w+\-(?:conte|avail)/,C=/([^-])(image-set\()/,W="-webkit-",H="-moz-",z="-ms-",V=59,Y=125,Z=123,J=40,X=41,G=91,K=93,Q=10,$=13,ee=9,te=64,ne=32,re=38,ae=45,x=95,oe=42,ie=44,ce=58,ue=39,le=34,se=47,de=62,fe=43,pe=126,he=0,me=12,ve=11,ge=107,ye=109,be=115,we=112,Se=111,Ee=105,Ce=99,xe=100,_e=112,ke=1,Te=1,Me=0,Re=1,Ne=1,Ie=1,_=0,Oe=0,Ae=0,Pe=[],k=[],je=0,T=null,M=-2,R=-1,Le=0,De=1,Be=2,Fe=3,Ue=0,qe=1,We="",He="",ze=""
function Ve(e,t,n,r,a){for(var o,i,c=0,u=0,l=0,s=0,d=0,f=0,p=0,h=0,m=0,v=0,g=0,y=0,b=0,w=0,S=0,E=0,C=0,x=0,_=0,k=n.length,T=k-1,M="",R="",N="",I="",O="",A="";S<k;){if(p=n.charCodeAt(S),S===T&&u+s+l+c!==0&&(0!==u&&(p=u===se?Q:se),s=l=c=0,k++,T++),u+s+l+c===0){if(S===T&&(0<E&&(R=R.replace(j,"")),0<R.trim().length)){switch(p){case ne:case ee:case V:case $:case Q:break
default:R+=n.charAt(S)}p=V}if(1===C)switch(p){case Z:case Y:case V:case le:case ue:case J:case X:case ie:C=0
case ee:case $:case Q:case ne:break
default:for(C=0,_=S,d=p,S--,p=V;_<k;)switch(n.charCodeAt(_++)){case Q:case $:case V:++S,p=d,_=k
break
case ce:0<E&&(++S,p=d)
case Z:_=k}}switch(p){case Z:for(R=R.trim(),d=R.charCodeAt(0),g=1,_=++S;S<k;){switch(p=n.charCodeAt(S)){case Z:g++
break
case Y:g--
break
case se:switch(f=n.charCodeAt(S+1)){case oe:case se:S=Ke(f,S,T,n)}break
case G:p++
case J:p++
case le:case ue:for(;S++<T&&n.charCodeAt(S)!==p;);}if(0===g)break
S++}switch(N=n.substring(_,S),d===he&&(d=(R=R.replace(P,"").trim()).charCodeAt(0)),d){case te:switch(0<E&&(R=R.replace(j,"")),f=R.charCodeAt(1)){case xe:case ye:case be:case ae:o=t
break
default:o=Pe}if(N=Ve(t,o,N,f,a+1),_=N.length,0<Ae&&0===_&&(_=R.length),0<je&&(o=Ye(Pe,R,x),i=Ge(Fe,N,o,t,Te,ke,_,f,a,r),R=o.join(""),void 0!==i&&0===(_=(N=i.trim()).length)&&(f=0,N="")),0<_)switch(f){case be:R=R.replace(q,Xe)
case xe:case ye:case ae:N=R+"{"+N+"}"
break
case ge:R=R.replace(D,"$1 $2"+(0<qe?We:"")),N=R+"{"+N+"}",N=1===Ne||2===Ne&&Je("@"+N,3)?"@"+W+N+"@"+N:"@"+N
break
default:N=R+N,r===_e&&(I+=N,N="")}else N=""
break
default:N=Ve(t,Ye(t,R,x),N,r,a+1)}O+=N,b=x=E=w=C=y=0,N=R="",p=n.charCodeAt(++S)
break
case Y:case V:if(R=(0<E?R.replace(j,""):R).trim(),1<(_=R.length))switch(0===w&&((d=R.charCodeAt(0))===ae||96<d&&d<123)&&(_=(R=R.replace(" ",":")).length),0<je&&void 0!==(i=Ge(De,R,t,e,Te,ke,I.length,r,a,r))&&0===(_=(R=i.trim()).length)&&(R="\0\0"),d=R.charCodeAt(0),f=R.charCodeAt(1),d){case he:break
case te:if(f===Ee||f===Ce){A+=R+n.charAt(S)
break}default:if(R.charCodeAt(_-1)===ce)break
I+=Ze(R,d,f,R.charCodeAt(2))}x=E=w=C=y=0,R="",p=n.charCodeAt(++S)}}switch(p){case $:case Q:if(u+s+l+c+Oe===0)switch(v){case X:case ue:case le:case te:case pe:case de:case oe:case fe:case se:case ae:case ce:case ie:case V:case Z:case Y:break
default:0<w&&(C=1)}u===se?u=0:Re+y===0&&r!==ge&&0<R.length&&(E=1,R+="\0"),0<je*Ue&&Ge(Le,R,t,e,Te,ke,I.length,r,a,r),ke=1,Te++
break
case V:case Y:if(u+s+l+c===0){ke++
break}default:switch(ke++,M=n.charAt(S),p){case ee:case ne:if(s+c+u===0)switch(h){case ie:case ce:case ee:case ne:M=""
break
default:p!==ne&&(M=" ")}break
case he:M="\\0"
break
case me:M="\\f"
break
case ve:M="\\v"
break
case re:s+u+c===0&&0<Re&&(E=x=1,M="\f"+M)
break
case 108:if(s+u+c+Me===0&&0<w)switch(S-w){case 2:h===we&&n.charCodeAt(S-3)===ce&&(Me=h)
case 8:m===Se&&(Me=m)}break
case ce:s+u+c===0&&(w=S)
break
case ie:u+l+s+c===0&&(E=1,M+="\r")
break
case le:case ue:0===u&&(s=s===p?0:0===s?p:s)
break
case G:s+u+l===0&&c++
break
case K:s+u+l===0&&c--
...
case X:s+u+c===0&&l--
break
case J:if(s+u+c===0){if(0===y)switch(2*h+3*m){case 533:break
default:g=0,y=1}l++}break
case te:u+l+s+c+w+b===0&&(b=1)
break
case oe:case se:if(0<s+c+l)break
switch(u){case 0:switch(2*p+3*n.charCodeAt(S+1)){case 235:u=se
break
case 220:_=S,u=oe}break
case oe:p===se&&h===oe&&_+2!==S&&(33===n.charCodeAt(_+2)&&(I+=n.substring(_,S+1)),M="",u=0)}}if(0===u){if(Re+s+c+b===0&&r!==ge&&p!==V)switch(p){case ie:case pe:case de:case fe:case X:case J:if(0===y){switch(h){case ee:case ne:case Q:case $:M+="\0"
break
default:M="\0"+M+(p===ie?"":"\0")}E=1}else switch(p){case J:w+7===S&&108===h&&(w=0),y=++g
break
case X:0==(y=--g)&&(E=1,M+="\0")}break
case ee:case ne:switch(h){case he:case Z:case Y:case V:case ie:case me:case ee:case ne:case Q:case $:break
default:0===y&&(E=1,M+="\0")}}R+=M,p!==ne&&p!==ee&&(v=p)}}m=h,h=p,S++}if(_=I.length,0<Ae&&0===_&&0===O.length&&0===t[0].length==0&&(r!==ye||1===t.length&&(0<Re?He:ze)===t[0])&&(_=t.join(",").length+2),0<_){if(o=0===Re&&r!==ge?function(e){for(var t,n,r=0,a=e.length,o=Array(a);r<a;++r){for(var i=e[r].split(L),c="",u=0,l=0,s=0,d=0,f=i.length;u<f;++u)if(!(0===(l=(n=i[u]).length)&&1<f)){if(s=c.charCodeAt(c.length-1),d=n.charCodeAt(0),t="",0!==u)switch(s){case oe:case pe:case de:case fe:case ne:case J:break
default:t=" "}switch(d){case re:n=t+He
case pe:case de:case fe:case ne:case X:case J:break
case G:n=t+n+He
break
case ce:switch(2*n.charCodeAt(1)+3*n.charCodeAt(2)){case 530:if(0<Ie){n=t+n.substring(8,l-1)
break}default:(u<1||i[u-1].length<1)&&(n=t+He+n)}break
case ie:t=""
default:n=1<l&&0<n.indexOf(":")?t+n.replace(U,"$1"+He+"$2"):t+n+He}c+=n}o[r]=c.replace(j,"").trim()}return o}(t):t,0<je&&void 0!==(i=Ge(Be,I,o,e,Te,ke,_,r,a,r))&&0===(I=i).length)return A+I+O
if(I=o.join(",")+"{"+I+"}",Ne*Me!=0){switch(2!==Ne||Je(I,2)||(Me=0),Me){case Se:I=I.replace(F,":"+H+"$1")+I
break
case we:I=I.replace(B,"::"+W+"input-$1")+I.replace(B,"::"+H+"$1")+I.replace(B,":"+z+"input-$1")+I}Me=0}}return A+I+O}function Ye(e,t,n){var r=t.trim().split(p),a=r,o=r.length,i=e.length
switch(i){case 0:case 1:for(var c=0,u=0===i?"":e[0]+" ";c<o;++c)a[c]=N(u,a[c],n,i).trim()
break
default:for(var c=0,l=0,a=[];c<o;++c)for(var s=0;s<i;++s)a[l++]=N(e[s]+" ",r[c],n,i).trim()}return a}function N(e,t,n,r){var a=t,o=a.charCodeAt(0)
switch(o<33&&(o=(a=a.trim()).charCodeAt(0)),o){case re:switch(Re+r){case 0:case 1:if(0===e.trim().length)break
default:return a.replace(i,"$1"+e.trim())}break
case ce:switch(a.charCodeAt(1)){case 103:if(0<Ie&&0<Re)return a.replace(h,"$1").replace(i,"$1"+ze)
break
default:return e.trim()+a.replace(i,"$1"+e.trim())}default:if(0<n*Re&&0<a.indexOf("\f"))return a.replace(i,(e.charCodeAt(0)===ce?"":"$1")+e.trim())}return e+a}function Ze(e,t,n,r){var a,o=0,i=e+";",c=2*t+3*n+4*r
if(944===c)return function(e){var t=e.length,n=e.indexOf(":",9)+1,r=e.substring(0,n).trim(),a=e.substring(n,t-1).trim()
switch(e.charCodeAt(9)*qe){case 0:break
case ae:if(110!==e.charCodeAt(10))break
default:for(var o=a.split((a="",d)),i=0,n=0,t=o.length;i<t;n=0,++i){for(var c=o[i],u=c.split(f);c=u[n];){var l=c.charCodeAt(0)
if(1===qe&&(te<l&&l<90||96<l&&l<123||l===x||l===ae&&c.charCodeAt(1)!==ae))switch(isNaN(parseFloat(c))+(-1!==c.indexOf("("))){case 1:switch(c){case"infinite":case"alternate":case"backwards":case"running":case"normal":case"forwards":case"both":case"none":case"linear":case"ease":case"ease-in":case"ease-out":case"ease-in-out":case"paused":case"reverse":case"alternate-reverse":case"inherit":case"initial":case"unset":case"step-start":case"step-end":break
default:c+=We}}u[n++]=c}a+=(0===i?"":",")+u.join(" ")}}return a=r+a+";",1===Ne||2===Ne&&Je(a,1)?W+a+a:a}(i)
if(0===Ne||2===Ne&&!Je(i,1))return i
switch(c){case 1015:return 97===i.charCodeAt(10)?W+i+i:i
case 951:return 116===i.charCodeAt(3)?W+i+i:i
case 963:return 110===i.charCodeAt(5)?W+i+i:i
case 1009:if(100!==i.charCodeAt(4))break
case 969:case 942:return W+i+i
case 978:return W+i+H+i+i
case 1019:case 983:return W+i+H+i+z+i+i
case 883:return i.charCodeAt(8)===ae?W+i+i:0<i.indexOf("image-set(",11)?i.replace(C,"$1"+W+"$2")+i:i
case 932:if(i.charCodeAt(4)===ae)switch(i.charCodeAt(5)){case 103:return W+"box-"+i.replace("-grow","")+W+i+z+i.replace("grow","positive")+i
case 115:return W+i+z+i.replace("shrink","negative")+i
case 98:return W+i+z+i.replace("basis","preferred-size")+i}return W+i+z+i+i
case 964:return W+i+z+"flex-"+i+i
case 1023:if(99!==i.charCodeAt(8))break
return a=i.substring(i.indexOf(":",15)).replace("flex-","").replace("space-between","justify"),W+"box-pack"+a+W+i+z+"flex-pack"+a+i
case 1005:return l.test(i)?i.replace(u,":"+W)+i.replace(u,":"+H)+i:i
case 1e3:switch(a=i.substring(13).trim(),o=a.indexOf("-")+1,a.charCodeAt(0)+a.charCodeAt(o)){case 226:a=i.replace(w,"tb")
break
case 232:a=i.replace(w,"tb-rl")
break
case 220:a=i.replace(w,"lr")
break
default:return i}return W+i+z+a+i
case 1017:if(-1===i.indexOf("sticky",9))return i
case 975:switch(o=(i=e).length-10,a=(33===i.charCodeAt(o)?i.substring(0,o):i).substring(e.indexOf(":",7)+1).trim(),c=a.charCodeAt(0)+(0|a.charCodeAt(7))){case 203:if(a.charCodeAt(8)<111)break
case 115:i=i.replace(a,W+a)+";"+i
break
case 207:case 102:i=i.replace(a,W+(102<c?"inline-":"")+"box")+";"+i.replace(a,W+a)+";"+i.replace(a,z+a+"box")+";"+i}return i+";"
case 938:if(i.charCodeAt(5)===ae)switch(i.charCodeAt(6)){case 105:return a=i.replace("-items",""),W+i+W+"box-"+a+z+"flex-"+a+i
case 115:return W+i+z+"flex-item-"+i.replace(S,"")+i
default:return W+i+z+"flex-line-pack"+i.replace("align-content","").replace(S,"")+i}break
case 973:case 989:if(i.charCodeAt(3)!==ae||122===i.charCodeAt(4))break
case 931:case 953:if(!0===E.test(e))return 115===(a=e.substring(e.indexOf(":")+1)).charCodeAt(0)?Ze(e.replace("stretch","fill-available"),t,n,r).replace(":fill-available",":stretch"):i.replace(a,W+a)+i.replace(a,H+a.replace("fill-",""))+i
break
case 962:if(i=W+i+(102===i.charCodeAt(5)?z+i:"")+i,n+r===211&&105===i.charCodeAt(13)&&0<i.indexOf("transform",10))return i.substring(0,i.indexOf(";",27)+1).replace(s,"$1"+W+"$2")+i}return i}function Je(e,t){var n=e.indexOf(1===t?":":"{"),r=e.substring(0,3!==t?n:10),a=e.substring(n+1,e.length-1)
return T(2!==t?r:r.replace(o,"$1"),a,t)}function Xe(e,t){var n=Ze(t,t.charCodeAt(0),t.charCodeAt(1),t.charCodeAt(2))
return n!==t+";"?n.replace(r," or ($1)").substring(4):"("+t+")"}function Ge(e,t,n,r,a,o,i,c,u,l){for(var s,d=0,f=t;d<je;++d)switch(s=k[d].call(I,e,f,n,r,a,o,i,c,u,l)){case void 0:case!1:case!0:case null:break
default:f=s}switch(f){case void 0:case!1:case!0:case null:case t:break
default:return f}}function Ke(e,t,n,r){for(var a=t+1;a<n;++a)switch(r.charCodeAt(a)){case se:if(e===oe&&r.charCodeAt(a-1)===oe&&t+2!==a)return a+1
break
case Q:if(e===se)return a+1}return a}function a(e){for(var t in e){var n=e[t]
switch(t){case"keyframe":qe=0|n
break
case"global":Ie=0|n
break
case"cascade":Re=0|n
...
break
case"prefix":T=null,n?"function"!=typeof n?Ne=1:(Ne=2,T=n):Ne=0}}return a}function I(e,t){if(void 0!==this&&this.constructor===I)return c(e)
var n=e,r=n.charCodeAt(0)
r<33&&(r=(n=n.trim()).charCodeAt(0)),0<qe&&(We=n.replace(m,r===G?"":"-")),(r=1)===Re?ze=n:He=n
var a,o=[ze]
0<je&&void 0!==(a=Ge(R,t,o,o,Te,ke,0,0,0,0))&&"string"==typeof a&&(t=a)
var i=Ve(Pe,o,t,0,0)
return 0<je&&void 0!==(a=Ge(M,i,o,o,Te,ke,i.length,0,0,0))&&"string"!=typeof(i=a)&&(r=0),He=ze=We="",ke=Te=1,_*r==(Me=0)?i:i.replace(j,"").replace(v,"").replace(g,"$1").replace(y,"$1").replace(b," ")}return I.use=function e(t){switch(t){case void 0:case null:je=k.length=0
break
default:switch(t.constructor){case Array:for(var n=0,r=t.length;n<r;++n)e(t[n])
break
case Function:k[je++]=t
break
case Boolean:Ue=0|!!t}}return e},I.set=a,void 0!==e&&a(e),I}(null)},"2qqa":function(e,t,n){"use strict"
var r=n("TqRt")
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var N=a(n("J4zp")),o=a(n("lwsE")),i=a(n("W8MJ")),u=a(n("a1gu")),l=a(n("Nsbk")),c=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),f=a(n("17x9")),I=r(n("q1tI")),O=a(n("M8nv")),A=a(n("foKU")),P=a(n("tBsX")),j=n("oose"),L=a(n("dYO+")),D=a(n("DdUa")),B=a(n("kJQk")),F=a(n("9ZUU")),U=a(n("TSYQ"))
n("fSKh")
...
c.default)(t,e),(0,i.default)(t,[{key:"render",value:function(){var r=this,e=this.props,t=e.scale,n=e.canvasOffset,a=e.project,o=e.screen,i=e.isSpaceDown,c=e.isStickyShow,u=e.isScrollable,l=e.shellType,s=e.isLayerActive,d=e.isCommentActive,f=e.isColorPickerActive,p=e.isFullScreenMode,h=n.x,m=n.y,v="landscape"===o.orientation,g=s||d,y=g||!u?"none":l,b=a.width,w=a.height,S=v?[w,b]:[b,w],E=(0,N.default)(S,2),C=E[0],x=E[1],_={width:C,height:x,minWidth:C,minHeight:x,transform:"matrix(1, 0, 0, 1, ".concat(h,", "
).concat(m,")")},k={transform:"scale(".concat(t/100,")")},T={width:"".concat(t,"%"),height:"".concat(t,"%")},M={width:o.width*t/100,height:o.height*t/100},R=(0,U.default)({"wait-drag":i,"is-immersive":g,"is-layer-active":s,"is-screen-expanded":g||!u})
return I.default.createElement(A.default,{x:h,y:m,scale:t,id:"simulator-container",className:R,onMouseDown:this.handleMouseDown,onScaleChange:this.handleScaleChange,onOffsetChange:this.handleOffsetChange},function(e,t,n){return I.default.createElement("div",{key:"1",className:(0,U.default)("screen-viewport",{"is-fullscreen":p,"is-geely":"geely_center_control"===a.model}),style:_},I.default.createElement("div",{className:"zoom-area",style:k},I.default.createElement(D.default,null),
!g&&I.default.createElement(L.default,{project:a,shellType:y,isLandscape:v}),c&&I.default.createElement(F.default,null)),I.default.createElement("div",{className:"no-zoom-area-wrapper",style:T},I.default.createElement("div",{className:"no-zoom-area",style:M},I.default.createElement("div",{id:"ui-layers",className:"ui-layers ".concat(s?"is-active":"")},f&&I.default.createElement(B.default,null),s&&!f&&I.default.createElement(P.default,null)),I.default.createElement("div",{id:"ui-comment-marker-panel"},
I.default.createElement(j.CommentMarkerPanelContainer,{getContentElement:r.getContentElementRef})))))},I.default.createElement(O.default,{onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp}))}}]),t}(I.PureComponent);(t.default=p).propTypes={scale:f.default.number,canvasOffset:f.default.object,screen:f.default.object,project:f.default.object,shellType:f.default.string,isStickyShow:f.default.bool,isScrollable:f.default.bool,isSpaceDown:f.default.bool,isLayerActive:f.default.bool,
...
default:return e}}
var a=r(n("MVZn")),o={open:!1,event:{}}},"62JN":function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var r="function"==typeof Symbol&&Symbol.for,a=r?Symbol.for("react.element"):60103,o=r?Symbol.for("react.portal"):60106,i=r?Symbol.for("react.fragment"):60107,c=r?Symbol.for("react.strict_mode"):60108,u=r?Symbol.for("react.profiler"):60114,l=r?Symbol.for("react.provider"):60109,s=r?Symbol.for("react.context"):60110,d=r?Symbol.for("react.async_mode"):60111,f=r?Symbol.for("react.forward_ref"):60112,p=r?Symbol.for("react.placeholder"):60113
function h(e){if("object"==typeof e&&null!==e){var t=e.$$typeof
switch(t){case a:switch(e=e.type){case d:case i:case u:case c:return e
default:switch(e=e&&e.$$typeof){case s:case f:case l:return e
default:return t}}case o:return t}}}t.typeOf=h,t.AsyncMode=d,t.ContextConsumer=s,t.ContextProvider=l,t.Element=a,t.ForwardRef=f,t.Fragment=i,t.Profiler=u,t.Portal=o,t.StrictMode=c,t.isValidElementType=function(e){return"string"==typeof e||"function"==typeof e||e===i||e===d||e===u||e===c||e===p||"object"==typeof e&&null!==e&&("function"==typeof e.then||e.$$typeof===l||e.$$typeof===s||e.$$typeof===f)},t.isAsyncMode=function(e){return h(e)===d},t.isContextConsumer=function(e){return h(e)===s},
t.isContextProvider=function(e){return h(e)===l},t.isElement=function(e){return"object"==typeof e&&null!==e&&e.$$typeof===a},t.isForwardRef=function(e){return h(e)===f},t.isFragment=function(e){return h(e)===i},t.isProfiler=function(e){return h(e)===u},t.isPortal=function(e){return h(e)===o},t.isStrictMode=function(e){return h(e)===c}},"6PGs":function(e,t,n){e.exports={"screen-info":"_2v9yoyzXbIx0ZN2HixE5HA"}},"6ZRU":function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(n("q1tI")),a=r(n("17x9")),c=n("1qiG"),o=function(e){var t=e.refRect,n=e.screen,r=e.style,a=r.dashed,o=r.colorForLines
return i.default.createElement("div",{style:{position:"absolute",pointerEvents:"none",width:(0,c.toPercentage)(t.width/n.width),height:(0,c.toPercentage)(t.height/n.height),left:(0,c.toPercentage)(t.left/n.width),top:(0,c.toPercentage)(t.top/n.height),border:"1px ".concat(a?"dashed":"solid"," ").concat(o)}})}
...
var n="[...effects]",I=Object(H.n)(W,Object(H.z)(n,"all("+n+")")),O=l.sagaMonitor,o=l.logger,i=l.onError,c=o||H.s,A=function(e){var t=e.sagaStack
!t&&e.stack&&(t=-1!==e.stack.split("\n")[0].indexOf(e.message)?e.stack:"Error: "+e.message+"\n"+e.stack),c("error","uncaught at "+N,t||e.message||e)},P=Object(z.f)(T),j=Object.create(e)
y.cancel=H.u
...
try{var n=void 0;(n=t?r.throw(e):e===G?(D.isCancelled=!0,y.cancel(),H.q.func(r.return)?r.return(G):{done:!0,value:G}):e===X?H.q.func(r.return)?r.return():{done:!0}:r.next(e)).done?(D.isMainRunning=!1,D.cont&&D.cont(n.value)):B(n.value,a,"",y)}catch(e){D.isCancelled&&A(e),D.isMainRunning=!1,D.cont(e,!0)}}function b(t,n){r._isRunning=!1,P.close(),n?(t instanceof Error&&Object.defineProperty(t,"sagaStack",{value:"at "+N+" \n "+(t.sagaStack||t.stack),configurable:!0}),L.cont||(t instanceof Error&&i?i(t):A(t)),
r._error=t,r._isAborted=!0,r._deferredEnd&&r._deferredEnd.reject(t)):(r._result=t,r._deferredEnd&&r._deferredEnd.resolve(t)),L.cont&&L.cont(t,n),L.joiners.forEach(function(e){return e.cb(t,n)}),L.joiners=null}function B(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"",r=arguments[3],a=Object(H.y)()
O&&O.effectTriggered({effectId:a,parentEffectId:t,label:n,effect:e})
var o=void 0
function i(e,t){o||(o=!0,r.cancel=H.u,O&&(t?O.effectRejected(a,e):O.effectResolved(a,e)),r(e,t))}i.cancel=H.u,r.cancel=function(){if(!o){o=!0
try{i.cancel()}catch(e){A(e)}i.cancel=H.u,O&&O.effectCancelled(a)}}
var c,u,l,s,d,f,p,h,m,v,g,y,b,w,S,E,C,x,_,k=void 0
return H.q.promise(e)?F(e,i):H.q.helper(e)?q(Q(e),a,i):H.q.iterator(e)?U(e,a,N,i):H.q.array(e)?I(e,a,i):(k=Y.d.take(e))?function(e,t){var n=e.channel,r=e.pattern,a=e.maybe
n=n||P
var o=function(e){return e instanceof Error?t(e,!0):Object(z.e)(e)&&!a?t(X):t(e)}
try{n.take(o,K(r))}catch(e){return t(e,!0)}t.cancel=o.cancel}(k,i):(k=Y.d.put(e))?(E=i,C=(S=k).channel,x=S.action,_=S.resolve,void Object(V.a)(function(){var e=void 0
try{e=(C?C.put:M)(x)}catch(e){if(C||_)return E(e,!0)
A(e)}if(!_||!H.q.promise(e))return E(e)
F(e,E)})):(k=Y.d.all(e))?W(k,a,i):(k=Y.d.race(e))?(m=k,v=a,g=i,y=void 0,b=Object.keys(m),w={},b.forEach(function(a){var e=function(e,t){if(!y)if(t)g.cancel(),g(e,!0)
...
try{i=a.apply(r,o)}catch(e){return n(e,!0)}return H.q.promise(i)?F(i,n):H.q.iterator(i)?U(i,t,a.name,n):n(i)}(k,a,i):(k=Y.d.cps(e))?function(e,n){var t=e.context,r=e.fn,a=e.args
...
t(a)}catch(e){t(e,!0)}}(k,i):(k=Y.d.actionChannel(e))?(d=i,f=(s=k).pattern,p=s.buffer,(h=K(f)).pattern=f,void d(Object(z.d)(T,p||Z.a.fixed(),h))):(k=Y.d.flush(e))?(l=i,void k.flush(l)):(k=Y.d.cancelled(e))?void i(!!D.isCancelled):(k=Y.d.getContext(e))?void i(j[k]):(k=Y.d.setContext(e))?(c=k,u=i,H.v.assign(j,c),void u()):i(e)}function F(e,t){var n=e[H.a]
H.q.func(n)?t.cancel=n:H.q.func(e.abort)&&(t.cancel=function(){return e.abort()}),e.then(t,function(e){return t(e,!0)})}function U(e,t,n,r){S(e,T,M,R,j,l,t,n,r)}function q(e,t,n){var r=e.context,a=e.fn,o=e.args,i=e.detached,c=function(e){var t=e.context,n=e.fn,r=e.args
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.setVisibilityScreen=v,t.default=x
var l=r(n("o0o1")),y=r(n("MVZn")),a=r(n("J2m7")),s=n("oZtI"),d=n("upRB"),f=n("JfQ8"),u=n("Kkl0"),b=n("jvRN"),p=n("7q5O"),h=l.default.mark(v),o=l.default.mark(g),m=l.default.mark(S),i=l.default.mark(E),c=l.default.mark(x),w=[]
...
n=r.parent}}
function x(){return l.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,[g(),E()]
...
return c.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!(o=r.artboard_id&&a.find(function(e){return e.screen_cid===r.cid&&"image_view"===e.name&&e.image&&-1!==e.image.indexOf(String("/artboard_"))}))){e.next=13
...
s.setState({glassLeft:u,glassTop:l}),c<0&&s.clearGlassRect(),s.glassCtx.clearRect(0,0,r,n),a<1&&console.warn("Can't make the galss scale less than 1, It will make bed invision"),x(s.glassCtx,!1),s.glassCtx.drawImage(s.imageCanvas,Math.floor(i-r/2/s.finallyScale),Math.floor(c-n/2/s.finallyScale),Math.floor(r/s.finallyScale),Math.floor(n/s.finallyScale),-5,-5,r,n),C(s.glassCtx,"lightgray",10,10),_(s.glassCtx),k(s.glassCtx,"black",Math.floor((r-10)/2),Math.floor((n-10)/2),10,10),s.getColor()}),(0,f.default)((0
...
for(var o=r+5.5;o<e.canvas.height-n;o+=r)e.beginPath(),e.moveTo(0,o),e.lineTo(e.canvas.width,o),e.stroke()},x=function(e,t){e.mozImageSmoothingEnabled=t,e.webkitImageSmoothingEnabled=t,e.msImageSmoothingEnabled=t,e.imageSmoothingEnabled=t},_=function(e){e.beginPath(),e.strokeStyle="#8D9EA7",e.lineWidth=8,e.arc(100,100,96,0,2*Math.PI),e.stroke(),e.strokeStyle="#D4D7DC",e.lineWidth=5,e.arc(100,100,96,0,2*Math.PI),e.stroke()},k=function(e,t,n,r,a,o){e.beginPath(),n+=.5,r+=.5,e.strokeStyle=t,e.lineWidth=1,
...
var n=typeof e
return!("number"!=n&&"symbol"!=n&&"boolean"!=n&&null!=e&&!a(e))||i.test(e)||!o.test(e)||null!=t&&e in Object(t)}},An9T:function(e,t,n){e.exports={shell:"xQWL5y1StSdX9vRfMCP2i"}},B3BZ:function(e,t,n){"use strict"
...
var C=function(e){return"Enter"===e.key||13===e.which||13===e.keyCode},x=function(e){var t=e.avatar,n=e.width,r=e.height,a=e.name,o=e.index
e.isDot
return d.default.createElement("div",{className:g.default.avatarInform},d.default.createElement("img",{className:g.default.avatar,src:t,width:n,height:r}),d.default.createElement("div",{className:g.default["avatar-slide"]},o&&d.default.createElement("span",{className:g.default.index},"#".concat(o," ")),d.default.createElement("span",{className:"name"},a)))};(t.AvatarInformation=x).propTypes={avatar:p.default.string.isRequired,width:p.default.number,height:p.default.number,name:p.default.string,
index:p.default.number,isDot:p.default.bool},x.defaultProps={width:24,height:24}},CMye:function(e,t,n){var r=n("GoyQ")
...
S=a.Operation.arrayFindDelete,E=a.Operation.arrayFindMove,C=a.Operation.arrayFindSet,x={set:function(e,t){var n=t.key,r=t.value
...
return new o.ObjectScheme(e,r({},t),r({},x,n))},t.ArrayOf=function(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{}
return new o.ArrayScheme(e,[t],r({},_,n))},t.objectActMap=x,t.arrayActMap=_},Clcl:function(e,t,n){"use strict"
var r=n("TqRt")
...
case"utf8":case"utf-8":case void 0:return A(e).length
case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*n
case"hex":return n>>>1
case"base64":return P(e).length
default:if(r)return A(e).length
...
case"utf8":case"utf-8":return f=t,p=n,j(A(e,(d=this).length-f),d,f,p)
case"ascii":return y(this,e,t,n)
case"latin1":case"binary":return y(this,e,t,n)
case"base64":return u=this,l=t,s=n,j(P(e),u,l,s)
...
return o}function x(e,t,n){for(var r=e.slice(t,n),a="",o=0;o<r.length;o+=2)a+=String.fromCharCode(r[o]+256*r[o+1])
...
if(n<0)throw new RangeError("Index out of range")}function N(e,t,n,r,a){return a||R(e,0,n,4),o.write(e,t,n,r,23,4),n+4}function I(e,t,n,r,a){return a||R(e,0,n,8),o.write(e,t,n,r,52,8),n+8}d.prototype.slice=function(e,t){var n,r=this.length
...
this.length),o.read(this,e,!0,52,8)},d.prototype.readDoubleBE=function(e,t){return t||_(e,8,this.length),o.read(this,e,!1,52,8)},d.prototype.writeUIntLE=function(e,t,n,r){e=+e,t|=0,n|=0,r||k(this,e,t,n,Math.pow(2,8*n)-1,0)
var a=1,o=0
...
else{var i=d.isBuffer(e)?e:A(new d(e,r).toString()),c=i.length
...
if((t-=4)<0)break
o.push(n>>18|240,n>>12&63|128,n>>6&63|128,63&n|128)}}return o}function P(e){return c.toByteArray(function(e){if((e=(t=e,t.trim?t.trim():t.replace(/^\s+|\s+$/g,"")).replace(O,"")).length<2)return""
...
var u=c.reduce(function(e,t){var u=i[t],r=p[t],l=o[t],c=function(e,t){return{dataState:e.find(function(e){return e.cid===t}),dataModel:u.findByAttribute("cid",t)}}
...
n.d(t,"x",function(){return o}),n.d(t,"e",function(){return i}),n.d(t,"b",function(){return u}),n.d(t,"a",function(){return l}),n.d(t,"c",function(){return s}),n.d(t,"d",function(){return d}),n.d(t,"r",function(){return p}),n.d(t,"u",function(){return h}),n.d(t,"o",function(){return m}),n.d(t,"h",function(){return v}),n.d(t,"q",function(){return b}),n.d(t,"v",function(){return w}),n.d(t,"w",function(){return S}),n.d(t,"f",function(){return E}),n.d(t,"l",function(){return C}),n.d(t,"g",function(){return x}),
n.d(t,"m",function(){return _}),n.d(t,"j",function(){return k}),n.d(t,"y",function(){return M}),n.d(t,"t",function(){return I}),n.d(t,"s",function(){return O}),n.d(t,"n",function(){return A}),n.d(t,"z",function(){return P}),n.d(t,"p",function(){return j}),n.d(t,"k",function(){return L}),n.d(t,"A",function(){return D}),n.d(t,"i",function(){return B})
var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
...
return e}
function v(e,t,n){if(!t(e))throw O("error","uncaught at check",n),new Error(n)}var g=Object.prototype.hasOwnProperty
...
return n.promise=t,n}function x(e){for(var t=[],n=0;n<e;n++)t.push(C())
...
function I(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:R,n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"",r=arguments[3],a={name:n,next:e,throw:t,return:N}
return r&&(a[c]=!0),"undefined"!=typeof Symbol&&(a[Symbol.iterator]=function(){return a}),a}function O(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:""
"undefined"==typeof window?console.log("redux-saga "+e+": "+t+"\n"+(n&&n.stack||n)):console[e](t,n)}function A(e,t){return function(){return e.apply(void 0,arguments)}}var P=function(e,t){return e+" has been deprecated in favor of "+t+", please update your code"},j=function(e){return new Error("\n  redux-saga: Error checking hooks detected an inconsistent state. This is likely a bug\n  in redux-saga code and not yours. Thanks for reporting this in the project's github repo.\n  Error: "+e+"\n")},L=function(e
...
n.r(t),n.d(t,"getRichTextAttr",function(){return b}),n.d(t,"getHTML",function(){return L}),n.d(t,"setAttrForParas",function(){return we}),n.d(t,"checkIsAttrManagedInsideEditor",function(){return xe}),n.d(t,"configureEditor",function(){return h}),n.d(t,"editorBridge",function(){return ke})
...
return n?r[n]:r},w={regular:400,light:300,bold:700},S=function(t){return w[t]?t:Object.keys(w).find(function(e){return String(w[e])===String(t)})||"regular"},x=function(e){return"marginTop"===e?"paraSpacing":e},_=function(i,c,e){var t,n,r,a,u={}
return g.forEach(function(e){var t,n,r,a,o=(n=i[t=e],r=x(t),a=n.replace(/'|"/g,""),["fontSize","lineHeight","letterSpacing","paraSpacing"].includes(r)&&"px"===a.slice(-2)&&(a=Number(a.slice(0,-2))),a||c[e])
...
return i=0===c.length?[E({},u.child,{text:""})]:c.map(function(e){return E({text:e.innerText.replace(/(\r\n|\n|\r)/gm,""),boldType:Number(e.dataset.boldtype)?1:0},_(e.style,u.child,Number(e.dataset.boldtype)))}),{paraSpacing:(r=t,a=n,o=r===a.length-1&&1<a.length?r-1:r,Number(a[o].style.marginBottom.replace("px",""))),children:i}})},N=[["&","&amp;"],["<","&lt;"],[">","&gt;"]],I=[].concat(N).reverse(),O=function(e){var a=e
return N.forEach(function(e){var t=M(e,2),n=t[0],r=t[1]
return a=a.replace(new RegExp(n,"g"),r)}),a},A=p.getStyleStr,P=function(e){return Object.entries(e).map(function(e){var t=M(e,2),n=t[0],r=t[1]
return n.replace(/[A-Z]/g,function(e){return"-"+e.toLowerCase()})+":"+r+";"}).join(" ")},j=function(e){var t,n,r,a,o=R(e,"fontFamily"),i=R(e,"fontWeight"),c=R(e,"boldType")
return{fontFamily:(a=o,A.fontFamily?A.fontFamily(a):a),fontWeight:(t=i,n=c,r=w[t],Number(n)?700:r),fontSize:R(e,"fontSize")+"px",color:R(e,"color"),fontStyle:R(e,"fontStyle"),letterSpacing:R(e,"letterSpacing")+"px",lineHeight:R(e,"lineHeight")+"px",textDecoration:R(e,"textDecoration")}},L=function(e,t,n){for(var r="",a=t||{start:[0,0,0],end:[]},o=M(a.start,3),i=o[0],c=o[1],u=o[2],l=M(a.end,3),s=l[0],d=l[1],f=l[2],p=[],h=i;;h++){for(var m=e[h],v=[],g=h===i,y=h===s,b=h===i?c:0;;b++){var w=g&&b===c,S=y&&b===d,
E=m.children[b],C=E.text.slice(w?u:0,S?f:E.text.length),x=O(C)
if(v.push('<span class="'+T+'" data-boldtype="'+R(E,"boldType")+'" style="'+P(j(E))+'">'+(""===E.text?"<br>":x)+"</span>"),n&&(r+=C),b===(S?d:m.children.length-1))break}var _=v.join("")
if(p.push('<p style="'+P({lineHeight:0,marginBottom:m.paraSpacing+"px"})+'">'+_+"</p>"),n&&h!==s&&(r+="\n"),h===(y?s:e.length-1))break}var k=p.join("")
...
if(t[r]<n[r])return"forwards"}return"forwards"},q=function(e,t){var n=U(e),r="object"===(void 0===t?"undefined":c(t))?U(t):t
return r&&r!==n?{start:e.end,end:e.start}:E({},e)},W=function(e){return{start:[0,0,0],end:[e.length-1,e[e.length-1].children.length-1,e[e.length-1].children[e[e.length-1].children.length-1].text.length]}},H=function(e,t){var n=M(t,3),r=(n[0],n[1]),a=n[2],o=[],i=[]
return e.children.forEach(function(e,t){t<r&&o.push(E({},e)),r<t&&i.push(E({},e)),t===r&&0!==a&&o.push(E({},e,{text:e.text.slice(0,a)})),t===r&&a!==e.text.length&&i.push(E({},e,{text:e.text.slice(a)}))}),{before:o,after:i}},z=function(e,t,n){var d=n.start,f=n.end,p=t.replace(/[\r\n\t\v\f]+/g,"\n").split(/\n/),r=1===p.length&&""===p[0],a=M(d,2),h=a[0],o=a[1],i=M(f,2),m=i[0],c=i[1],v=[],g=[]
...
i.forEach(function(e,t){var a,n=(a=e,I.forEach(function(e){var t=M(e,2),n=t[0],r=t[1]
...
return"h1"===e?parseInt(.67*t):"h2"===e?parseInt(.83*t):"h3"===e?parseInt(1*t):"h4"===e?parseInt(1.33*t):"h5"===e?parseInt(1.67*t):"h6"===e?parseInt(2.33*t):void 0},le=function(e){return e.reduce(function(a,e){return Object.entries(e).forEach(function(e){var t=M(e,2),n=t[0],r=t[1]
...
if(i){var c=M(a,3),u=c[0],l=c[1],s=c[2],d=he(r[u],l,s)
r[u]=d,a=[u,l+1,0]}if(i&&(e[0]===t[0]&&(o[1]+=1),e[0]===t[0]&&e[1]===t[1]&&(o[2]-=e[2])),me(o,r)){var f=M(o,3),p=f[0],h=f[1],m=f[2],v=he(r[p],h,m)
r[p]=v}return{boundary:{start:a,end:o},paras:r}}(p.start,p.end,t)
v=r.boundary,n=r.paras}return{paras:(n||t).map(function(e,f){var t=e.children.map(function(e,t){return!p||(n=f,r=t,o=M((a=v).start,2),i=o[0],c=o[1],u=M(a.end,2),l=u[0],s=u[1],d=Math.max(r,c,s)+1,i*d+c<=n*d+r&&n*d+r<=l*d+s)?ge({span:e,attr:h,value:m}):E({},e)
...
return{paras:v,boundary:g||p}},Se=["fontFamily","fontWeight","boldType","fontSize","color","fontStyle","textDecoration","letterSpacing"],Ee="lineHeight",Ce="paraSpacing",xe=function(e){return["text"].concat(Se,[Ee,Ce]).includes(e)}
...
if(!F(r)){var a=q(r,"forwards"),o=L(n,a,!0),i=o.HTML,c=o.text
...
if(!F(r)){var a=q(r,"forwards"),o=L(n,a)
...
if(o){var i,s,c,d,f,p,u,h,m,v,g,l=Y(o),y=(i=n,s=l,d=(c=a).start,f=c.end,p=d[0],u=M(f,2),h=u[0],m=u[1],v=[],g=[],i.forEach(function(u,e,l){if(e<p||h<e)v.push(E({},u))
...
return a.a.createElement("div",{contentEditable:!0,dangerouslySetInnerHTML:{__html:L(e)},ref:function(e){return t.$editor=e},className:l,style:this.props.style,onKeyDown:this.handleKeyDown,onCompositionStart:this.handleCompositionStart,onCompositionEnd:this.handleCompositionEnd,onInput:this.handleInput,onSelect:this.handleSelectionChange,onCopy:this.handleCopy,onCut:this.handleCut,onPaste:this.handlePaste})}}]),t}(r.PureComponent)
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u=a(n("o0o1")),o=a(n("yXPU")),i=a(n("lwsE")),c=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),g=r(n("q1tI")),h=a(n("17x9")),y=n("DqDi"),b=a(n("i6OX")),w=a(n("4QcC")),S=a(n("Ur7v")),E=a(n("lCKy")),C=a(n("iX79")),m=n("/5+U"),x=n("1iCU"),v=n("t3Un"),_=n("Gbs1"),k=a(n("rtgd")),T=function(e){function t(e){var r
return(0,i.default)(this,t),r=(0,l.default)(this,(0,s.default)(t).call(this,e)),(0,p.default)((0,f.default)((0,f.default)(r)),"handleTabChange",function(e){var t=r.props.dispatch,n=x.PREVIEW_CONFIG[e]
t({type:"entry:preview:select",payload:{toolbarActiveItem:x.PREVIEW_CONFIG[e]}}),MB.event("".concat(x.TOOLBAR_TRAKING_CONFIG[n]),"运行页")}),e.dispatch({type:"reducer:preview-toolbar:active-item:init"}),I()&&r.props.dispatch({type:"entry:preview:select",payload:{toolbarActiveItem:x.INSPECT}}),r}return(0,d.default)(t,e),(0,c.default)(t,[{key:"UNSAFE_componentWillReceiveProps",value:function(e){var t=e.toolbarActiveItem,n=e.loadSliceUrl
t!=this.props.toolbarActiveItem&&this.props.dispatch({type:"reducer:preview-toolbar:update",payload:{isShowColorPicker:!1,isSelectLayer:!1}}),n!=this.props.loadSliceUrl&&N(n)}},{key:"render",value:function(){var e=this.props,t=e.scale,n=e.project,r=e.dispatch,a=e.toolbarActiveItem,o=e.existUnreadComment,i=e.isScrollable,c=e.isHighlight,u=e.isStickyShow,l=e.shellType,s=x.PREVIEW_CONFIG.indexOf(a)||0,d=a!=x.PREVIEW,f=n.name||"",p=!R(),h=MB.isHTMLZip()?x.PREVIEW_OFFLINE_ICON_LIST:x.PREVIEW_ICON_LIST,
...
return function(e){return t.apply(this,arguments)}}(),I=function(){return new URLSearchParams(location.search).has("inspect")}},H5Dy:function(e,t,n){"use strict"
...
t.default=l},HLqo:function(e,t,n){},HNPj:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=r(n("lwsE")),o=r(n("W8MJ")),i=r(n("a1gu")),c=r(n("Nsbk")),u=r(n("7W2i")),l=r(n("q1tI")),s=r(n("17x9")),d=r(n("Y69h")),f=r(n("7Rdd")),p=r(n("0uCA")),h=r(n("mCdf")),m=n("1qiG"),v=n("IdPL"),g=r(n("TjoA")),y=function(e){function t(){return(0,a.default)(this,t),(0,i.default)(this,(0,c.default)(t).apply(this,arguments))}return(0,u.default)(t,e),(0,o.default)(t,[{key:"shouldComponentUpdate",value:function(e){return!((0,m.checkSameRect)(e.baseRect,this.props.baseRect)&&(0,m.checkSameRect)(e.refRect,
...
return l.default.createElement("div",{className:g.default["distance-measurement-container"]},l.default.createElement(d.default,{baseRect:t,refRect:n,screen:r,style:v.STYLE_MAP[a].distanceMarks,renderValue:o}),i?l.default.createElement(p.default,{refRect:n,screen:r,style:v.STYLE_MAP[a].auxiliaryLines}):l.default.createElement(h.default,{baseRect:t,refRect:n,screen:r,style:v.STYLE_MAP[a].auxiliaryLines}),l.default.createElement(f.default,{refRect:n,screen:r,style:v.STYLE_MAP[a].refRectBorder}))}}]),t}(
l.default.Component);(t.default=y).propTypes={baseRect:s.default.object,refRect:s.default.object,screen:s.default.object,theme:s.default.string,renderValue:s.default.func}},HfeQ:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=a(n("PJYZ")),c=a(n("lSNA")),u=a(n("lwsE")),l=a(n("W8MJ")),s=a(n("a1gu")),d=a(n("Nsbk")),f=a(n("7W2i")),o=a(n("17x9")),p=r(n("q1tI")),h=n("uavl"),m=n("zQyp")
n("dAiO")
...
else{var u=[n,r,a,o,i,c],l=0;(e=Error(t.replace(/%s/g,function(){return u[l++]}))).name="Invariant Violation"}throw e.framesToPop=1,e}}(!1,"Minified React error #"+e+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",n)}var r="function"==typeof Symbol&&Symbol.for,c=r?Symbol.for("react.portal"):60106,u=r?Symbol.for("react.fragment"):60107,l=r?Symbol.for("react.strict_mode"):60108,s=r?Symbol.for("react.profiler"):60114,f=r?Symbol.for(
...
case v:return S(e.type)
case g:if(e=1===e._status?e._result:null)return S(e)}return null}var a=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,E={}
function C(e,t){for(var n=e._threadCount;n<=t;n++)e[n]=e._currentValue2,e._threadCount=n+1}for(var x=new Uint16Array(16),o=0;o<15;o++)x[o]=o+1
x[15]=0
var i=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,_=Object.prototype.hasOwnProperty,k={},T={}
function M(e){return!!_.call(T,e)||!_.call(k,e)&&(i.test(e)?T[e]=!0:!(k[e]=!0))}function R(e,t,n,r){if(null==t||function(e,t,n,r){if(null!==n&&0===n.type)return!1
...
case 6:return isNaN(t)||t<1}return!1}function N(e,t,n,r,a){this.acceptsBooleans=2===t||3===t||4===t,this.attributeName=r,this.attributeNamespace=a,this.mustUseProperty=n,this.propertyName=e,this.type=t}var I={}
"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){I[e]=new N(e,0,!1,e,null)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0]
I[t]=new N(t,1,!1,e[1],null)}),["contentEditable","draggable","spellCheck","value"].forEach(function(e){I[e]=new N(e,2,!1,e.toLowerCase(),null)}),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){I[e]=new N(e,2,!1,e,null)}),"allowFullScreen async autoFocus autoPlay controls default defer disabled formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){I[e]=new N(e,3,!1,
e.toLowerCase(),null)}),["checked","multiple","muted","selected"].forEach(function(e){I[e]=new N(e,3,!0,e,null)}),["capture","download"].forEach(function(e){I[e]=new N(e,4,!1,e,null)}),["cols","rows","size","span"].forEach(function(e){I[e]=new N(e,6,!1,e,null)}),["rowSpan","start"].forEach(function(e){I[e]=new N(e,5,!1,e.toLowerCase(),null)})
var O=/[\-:]([a-z])/g
function A(e){return e[1].toUpperCase()}
...
" ").forEach(function(e){var t=e.replace(O,A)
I[t]=new N(t,1,!1,e,null)}),"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var t=e.replace(O,A)
I[t]=new N(t,1,!1,e,"http://www.w3.org/1999/xlink")}),["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(O,A)
I[t]=new N(t,1,!1,e,"http://www.w3.org/XML/1998/namespace")}),I.tabIndex=new N("tabIndex",1,!1,"tabindex",null)
var P=/["'&<>]/
...
case 62:t="&gt;"
break
default:continue}a!==n&&(r+=e.substring(a,n)),a=n+1,r+=t}e=a!==n?r+e.substring(a,n):r}return e}var L=!1
function D(e,t,n,r){for(;L;)L=!1,n=e(t,r)
return n}var B=0,F={readContext:function(e){var t=B
return C(e,t),e[t]}},U="http://www.w3.org/1999/xhtml"
function q(e){switch(e){case"svg":return"http://www.w3.org/2000/svg"
case"math":return"http://www.w3.org/1998/Math/MathML"
default:return"http://www.w3.org/1999/xhtml"}}var W={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0},H=y({menuitem:!0},W),z={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,
gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},V=["Webkit","ms","Moz","O"]
Object.keys(z).forEach(function(t){V.forEach(function(e){e=e+t.charAt(0).toUpperCase()+t.substring(1),z[e]=z[t]})})
var Y=/([A-Z])/g,Z=/^ms-/,J=b.Children.toArray,X=a.ReactCurrentOwner,G={listing:!0,pre:!0,textarea:!0},K=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,Q={},$={}
var ee=Object.prototype.hasOwnProperty,te={children:null,dangerouslySetInnerHTML:null,suppressContentEditableWarning:null,suppressHydrationWarning:null}
function ne(e,t){void 0===e&&w("152",S(t)||"Component")}function re(f,p,h){function e(e,t){var n=function(e,t,n){var r=e.contextType
if("object"==typeof r&&null!==r)return C(r,n),r[n]
...
null!=c&&(i.state=y({},i.state,c))}}else if(i=t(e.props,n,o),null==(i=D(t,e.props,i,n))||null==i.render)return void ne(f=i,t)
...
if(ne(f=i.render(),t),e=void 0,"function"==typeof i.getChildContext&&"object"==typeof(n=t.childContextTypes))for(var d in e=i.getChildContext())d in n||w("108",S(t)||"Unknown",d)
e&&(p=y({},p,e))}for(;b.isValidElement(f);){var t=f,n=t.type
if("function"!=typeof n)break
e(t,n)}return{child:f,context:p}}var ae=function(){function i(e,t){if(!(this instanceof i))throw new TypeError("Cannot call a class as a function")
e=b.isValidElement(e)?e.type!==u?[e]:(e=e.props.children,b.isValidElement(e)?[e]:J(e)):J(e),e={type:null,domNamespace:U,children:e,childIndex:0,context:E,footer:""}
var n=x[0]
if(0===n){var r=x,a=2*(n=r.length)
a<=65536||w("304")
var o=new Uint16Array(a)
for(o.set(r),(x=o)[0]=n+1,r=n;r<a-1;r++)x[r]=r+1
x[a-1]=0}else x[0]=x[n]
...
var e=this.threadID
x[e]=x[0],x[0]=e}},i.prototype.pushProvider=function(e){var t=++this.contextIndex,n=e.type._context,r=this.threadID
C(n,r)
var a=n[r]
...
X.currentDispatcher=F
try{for(var r=[""],a=!1;r[0].length<e;){if(0===this.stack.length){this.exhausted=!0
var o=this.threadID
x[o]=x[0],x[0]=o
break}var i=this.stack[this.stack.length-1]
if(a||i.childIndex>=i.children.length){var c=i.footer
if(""!==c&&(this.previousWasTextNode=!1),this.stack.pop(),"select"===i.type)this.currentSelectValue=null
...
l||w("303"),this.stack.push(l)
continue}r[this.suspenseDepth]+=u}r[this.suspenseDepth]+=c}else{var s=i.children[i.childIndex++],d=""
try{d+=this.render(s,i.context,i.domNamespace)}catch(e){throw e}r.length<=this.suspenseDepth&&r.push(""),r[this.suspenseDepth]+=d}}return r[0]}finally{X.currentDispatcher=n,B=t}},i.prototype.render=function(e,t,n){if("string"==typeof e||"number"==typeof e)return""===(n=""+e)?"":this.makeStaticMarkup?j(n):this.previousWasTextNode?"\x3c!-- --\x3e"+j(n):(this.previousWasTextNode=!0,j(n))
...
r===c&&w("257"),w("258",r.toString())}return e=J(e),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""}if("string"==typeof(r=e.type))return this.renderDOM(e,t,n)
switch(r){case l:case p:case s:case u:return e=J(e.props.children),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""
case m:w("294")}if("object"==typeof r&&null!==r)switch(r.$$typeof){case h:var a=r.render(e.props,e.ref)
return a=D(r.render,e.props,a,e.ref),a=J(a),this.stack.push({type:null,domNamespace:n,children:a,childIndex:0,context:t,footer:""}),""
...
case f:return n={type:e,domNamespace:n,children:r=J(e.props.children),childIndex:0,context:t,footer:""},this.pushProvider(e),this.stack.push(n),""
case d:r=e.type,a=e.props
var o=this.threadID
return C(r,o),r=J(a.children(r[o])),this.stack.push({type:e,domNamespace:n,children:r,childIndex:0,context:t,footer:""}),""
case g:w("295")}w("130",null==r?r:typeof r,"")},i.prototype.renderDOM=function(e,t,n){var r=e.type.toLowerCase()
n===U&&q(r),Q.hasOwnProperty(r)||(K.test(r)||w("65",r),Q[r]=!0)
var a=e.props
...
break}}else o=""+i===u
a=y({selected:void 0,children:void 0},a,{selected:o,children:c})}}for(g in(o=a)&&(H[r]&&(null!=o.children||null!=o.dangerouslySetInnerHTML)&&w("137",r,""),null!=o.dangerouslySetInnerHTML&&(null!=o.children&&w("60"),"object"==typeof o.dangerouslySetInnerHTML&&"__html"in o.dangerouslySetInnerHTML||w("61")),null!=o.style&&"object"!=typeof o.style&&w("62","")),o=a,i=this.makeStaticMarkup,c=1===this.stack.length,u="<"+e.type,o)if(ee.call(o,g)){var s=o[g]
if(null!=s){if("style"===g){l=void 0
var d="",f=""
for(l in s)if(s.hasOwnProperty(l)){var p=0===l.indexOf("--"),h=s[l]
if(null!=h){var m=l
if($.hasOwnProperty(m))m=$[m]
else{var v=m.replace(Y,"-$1").toLowerCase().replace(Z,"-ms-")
m=$[m]=v}d+=f+m+":",f=l,d+=p=null==h||"boolean"==typeof h||""===h?"":p||"number"!=typeof h||0===h||z.hasOwnProperty(f)&&z[f]?(""+h).trim():h+"px",f=";"}}s=d||null}l=null
...
break e
default:p=!0}p?te.hasOwnProperty(g)||(l=M(l=g)&&null!=s?l+'="'+j(s)+'"':""):(p=g,l=s,s=I.hasOwnProperty(p)?I[p]:null,(h="style"!==p)&&(h=null!==s?0===s.type:2<p.length&&("o"===p[0]||"O"===p[0])&&("n"===p[1]||"N"===p[1])),l=h||R(p,l,s,!1)?"":null!==s?(p=s.attributeName,3===(s=s.type)||4===s&&!0===l?p+'=""':p+'="'+j(l)+'"'):M(p)?p+'="'+j(l)+'"':""),l&&(u+=" "+l)}}i||c&&(u+=' data-reactroot=""')
var g=u
o="",W.hasOwnProperty(r)?g+="/>":(g+=">",o="</"+e.type+">")
...
break e}i=null}return null!=i?(a=[],G[r]&&"\n"===i.charAt(0)&&(g+="\n"),g+=i):a=J(a.children),e=e.type,n=null==n||"http://www.w3.org/1999/xhtml"===n?q(e):"http://www.w3.org/2000/svg"===n&&"foreignObject"===e?"http://www.w3.org/1999/xhtml":n,this.stack.push({domNamespace:n,type:r,children:a,childIndex:0,context:t,footer:o}),this.previousWasTextNode=!1,g},i}(),oe={renderToString:function(e){e=new ae(e,!1)
try{return e.read(1/0)}finally{e.destroy()}},renderToStaticMarkup:function(e){e=new ae(e,!0)
try{return e.read(1/0)}finally{e.destroy()}},renderToNodeStream:function(){w("207")},renderToStaticNodeStream:function(){w("208")},version:"16.6.3"},ie=oe
e.exports=ie.default||ie},IOzZ:function(e,t){e.exports=function(t,n){return function(e){return null!=e&&e[t]===n&&(void 0!==n||t in Object(e))}}},IT1M:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var r=n("JGuq")
...
return e.forEach(function(e){t.containerReducerMap=r(a,t.containerReducerMap,e.containerReducerMap),t.viewMap=r(a,t.viewMap,e.viewMap),t.extendCallback=r(o,t.extendCallback,e.extendCallback),t.sagaMap=r(a,t.sagaMap,e.sagaMap)}),t}},JXIg:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(n("pVnL")),c=r(n("lwsE")),o=r(n("W8MJ")),u=r(n("a1gu")),l=r(n("Nsbk")),s=r(n("7W2i")),d=r(n("PJYZ")),f=r(n("lSNA")),a=r(n("MVZn")),p=r(n("J4zp")),h=r(n("17x9")),m=r(n("q1tI")),v=r(n("HNPj")),g=n("/5+U"),y=r(n("dZ9F")),b=function(e){var t=e.kind?0:e.rotation,n=(0,g.getMinBoundingRect)((0,a.default)({},e,{rotate:t})),r=(0,p.default)(n,4)
return{top:r[0],left:r[1],width:r[2],height:r[3]}},w=function(e){function a(){var e,o;(0,c.default)(this,a)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return o=(0,u.default)(this,(e=(0,l.default)(a)).call.apply(e,[this].concat(n))),(0,f.default)((0,d.default)((0,d.default)(o)),"renderValue",function(e){var t=o.props,n=t.ratio,r=t.distanceUnit,a=o.getValueRatio()
...
w.propTypes={show:h.default.bool,selectedLayer:h.default.object,hoveringLayer:h.default.object,screen:h.default.object}
var S=w
t.default=S},KKmY:function(e,t,n){},Kkl0:function(e,t,n){"use strict"
...
t.default=v,(0,d.default)(v,"propTypes",{activeCid:p.default.string,screenTreeMap:p.default.object,screenDataMap:p.default.object,renderCommentIcon:p.default.func,dispatch:p.default.func})},NYM8:function(e,t,n){},NZ2w:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var E="px",C="pt",x="dp",_=[E,"em","rem",x,C],k=[{value:"swift",label:"Swift"},{value:"android",label:"Android"},{value:"css",label:"CSS"},{value:"less",label:"Less"},{value:"sass",label:"Sass"},{value:"stylus",label:"Stylus"}],T=[{value:"hex",label:"Hex"},{value:"rgb",label:"RGB"},{value:"rgba",label:"RGBA"},{value:"argb",label:"ARGB"}],M=[1,2,3].map(function(e){return{value:e,label:"@".concat(e,"x")}}),R=[.75,1,1.5,2,3,4].map(function(e){return{value:e,label:"@".concat(e,"x")}}),N=function(e,t){
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u=a(n("o0o1")),o=a(n("yXPU")),i=a(n("pVnL")),c=a(n("MVZn")),s=a(n("lwsE")),l=a(n("W8MJ")),d=a(n("a1gu")),f=a(n("Nsbk")),p=a(n("7W2i")),h=a(n("PJYZ")),m=a(n("lSNA")),v=r(n("q1tI")),g=a(n("17x9")),y=n("6XO9"),b=n("wCGR"),w=n("7Qib"),S=n("nLLt"),E=n("XkTy"),C=n("rbsZ"),x=n("zAG7")
n("mnpx")
var _=I18N.open_parenthesis+I18N.pending+I18N.close_parenthesis,k={user:0,owner:1,admin:2,editor:3,viewer:4},T=function(e){var t=e.host,n=e.userRole
...
return v.default.createElement("li",{className:"collaborator"},v.default.createElement("div",{className:"user"},v.default.createElement("img",{className:"avatar",src:u}),v.default.createElement("span",{className:"user-name"},l||s),!l&&v.default.createElement("span",{className:"pending"},_)),p?v.default.createElement(y.Select,{unstyled:!0,size:"small",optionList:f,value:d,onChange:this.onChangeRole}):v.default.createElement("span",{className:"role"},I18N.roles[d]),p&&v.default.createElement(y.Button,{
...
return e=e||0===t.length,v.default.createElement("ul",(0,i.default)({className:"prompt-list"},(0,w.setHidden)(e)),t.map(function(e){return v.default.createElement("li",{key:e.email,onMouseDown:l.createOnClickPromptListItemHandler(e.email)},v.default.createElement("img",{className:"avatar",src:e.avatar}),v.default.createElement("span",{className:"user-name"},e.name||e.email),e.name?v.default.createElement("span",{className:"user-email"},e.email):v.default.createElement("span",{className:"pending"},_))}))}),(
...
var a=e.limitation,o=void 0===a?MB.user.limitation:a,i=e.collaborators(),c=void 0!==i.find(function(e){return e.email===n}),u=n&&x.EMAIL_REG.test(n)?n===MB.user.email?I18N.cant_invite_yourself:c?I18N.already_invited:i.length>o.collaborators?l.errorMsg():null:I18N.invalid_email
...
var R=r(n("J4zp")),x=function(e){e.top,e.left
...
t.getLineAttrsAsWidget=I
t.getLineAttrsAfterRotate=function(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,r=_(t),a=e.top,o=e.left,i=e.width,c=e.height,u=e.points,l=JSON.parse(u).map(function(e){return e.point}),s=(0,R.default)(l,2),d=(0,R.default)(s[0],2),f=d[0],p=d[1],h=(0,R.default)(s[1],2),m=h[0],v=h[1],g=x(e).length,y=[o+i*f,a+c*p],b=[o+i*m,a+c*v],w=[y[0]+(b[0]-y[0])*n,y[1]+(b[1]-y[1])*n],S=[y[0]+g*Math.cos(r),y[1]+g*Math.sin(r)],E=[y[0]+(S[0]-y[0])*n,y[1]+(S[1]-y[1])*n],C=[w[0]-E[0],w[1]-E[1]]
return I([y[0]+C[0],y[1]+C[1]],[S[0]+C[0],S[1]+C[1]])}
...
n.props.dispatch({type:"reducer:preview-toolbar:update",payload:{userPickColor:t}}),MB.event("删除了自选颜色","运行页")}),(0,f.default)((0,d.default)((0,d.default)(n)),"handleClick",function(e){var t=e.target.dataset.trackId
...
return m.default.createElement("div",{className:S("global-attributes"),onClick:this.handleClick},m.default.createElement("div",{className:S("container","global-layer")},m.default.createElement(g.Base,{trackId:"宽高",title:I18N.preview_panel.size,dataValue:[I18N.preview_panel.width,I18N.preview_panel.height],data:[t,n]})),m.default.createElement(g.WrapComponent,null,I18N.preview_panel.color_title,m.default.createElement(k,{trackId:"自选颜色",title:I18N.preview_panel.pick_color,handleDelColor:this.handleDelColor,
colorBlockMap:f,colorUnit:p,canDel:!0}),m.default.createElement(_,{trackId:"页面颜色",title:I18N.preview_panel.screen_color,handleDelColor:this.handleDelColor,colorBlockMap:a,colorUnit:p}),m.default.createElement(_,{trackId:"Sketch 文件颜色",title:I18N.preview_panel.sketch_color,handleDelColor:this.handleDelColor,colorBlockMap:h,colorUnit:p,fromSketch:!0})),0<u.length&&m.default.createElement(g.WrapComponent,null,I18N.preview_panel.font_title,m.default.createElement(x,{globalText:u})))}}]),o}(m.PureComponent);(
t.GlobalAttributes=C).propTypes={adapterWidth:p.default.string.isRequired,adapterHeight:p.default.string.isRequired,colorUnit:p.default.string.isRequired,screenColor:p.default.array,userPickColor:p.default.array,documentColor:p.default.array,globalText:p.default.array,globalColor:p.default.array,dispatch:p.default.func}
var x=function(e){return e.globalText.map(function(e){return m.default.createElement(g.Base,{key:e,className:"global-font",data:[e]})})}
x.propTypes={globalText:p.default.array}
var _=function(e){var a=e.trackId,t=e.title,n=e.colorBlockMap,o=e.fromSketch,i=e.handleDelColor,c=e.canDel,u=e.colorUnit,l=e.focusColor
return m.default.createElement("div",null,m.default.createElement("span",{className:"second-title"},t),m.default.createElement("div",{className:"panel-row"},n.length?n.map(function(e,t){var n=T(o,e,"rgba"),r=(0,y.getColorFromUnit)(n,u)
return m.default.createElement(M,{key:"".concat(t).concat(e),canDel:c,trackId:a,handleDelColor:i,color:r,rgbaColor:n,colorUnit:u,focusColor:l})}):m.default.createElement(R,null)))}
_.propTypes={trackId:p.default.string,title:p.default.string.isRequired,colorBlockMap:p.default.array.isRequired,handleDelColor:p.default.func.isRequired,fromSketch:p.default.bool,canDel:p.default.bool,colorUnit:p.default.string,focusColor:p.default.string}
var k=(0,o.connect)(function(e){var t=e.container.previewSetting
return{userPickColor:t.userPickColor,focusColor:t.focusColor}})(_),T=function(e,t,n){return(0,y.getColorFromUnit)(e?(0,y.parseSketchColor2rgba)(t):t,n)},M=function(e){var t=e.color,n=e.rgbaColor,r=e.colorUnit,a=e.handleDelColor,o=e.canDel,i=e.trackId,c=e.focusColor,u=t===(0,y.getColorFromUnit)(c,r)
...
M.propTypes={color:p.default.string.isRequired,trackId:p.default.string,handleDelColor:p.default.func,colorUnit:p.default.string,rgbaColor:p.default.string,canDel:p.default.bool,focusColor:p.default.string}
...
t.transfromProptype=function(e){var t=e.attr,n=e.language,r=e.unit,a=(0,B.selectWithlanguageUnit)(n),o=t.width,i=t.height,c=t.lineHeight,u=t.opacity,l=t.borderRadius,s=t.borderWidth,d=t.borderColor,f=t.backgroundColor,p=t.color,h=t.fontSize,m=t.fontFamily,v=t.fontStyle,g=t.boxShadow,y=t.textAlign,b=t.x,w=t.y,S=b&&(0,D.default)({},U[a].x,F(b,r,a)),E=w&&(0,D.default)({},U[a].y,F(w,r,a)),C=o&&(0,D.default)({},U[a].width,F(o,r,a)),x=i&&(0,D.default)({},U[a].height,F(i,r,a)),_=c&&(0,D.default)({},U[a].lineHeight
,F(c,r,a)),k=u&&(0,D.default)({},U[a].opacity,F(u,r,a)),T=l&&(0,D.default)({},U[a].borderRadius,F(l,r,a)),M=f&&(0,D.default)({},U[a].backgroundColor,F(f,r,a,!0)),R=p&&(0,D.default)({},U[a].color,F(p,r,a,!0)),N=h&&(0,D.default)({},U[a].fontSize,F(h,r,a)),I=m&&(0,D.default)({},U[a].fontFamily,F(m,r,a)),O=v&&(0,D.default)({},U[a].fontStyle,F(v,r,a)),A=g&&(0,D.default)({},U[a].shadows,g),P=s&&(0,D.default)({},U[a].borderWidth,F(s,r,a)),j=d&&(0,D.default)({},U[a].borderColor,F(d,r,a,!0)),L=y&&(0,D.default)({},
U[a].textAlign,y)
return Object.assign({},S,E,C,x,_,k,T,P,j,M,R,N,O,L,A,I)}
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var y=a(n("RIqP")),o=a(n("o0o1")),c=a(n("yXPU")),u=a(n("lwsE")),i=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),b=r(n("q1tI")),h=a(n("17x9")),w=n("rbsZ"),m=n("t3Un"),v=n("XkTy"),S=n("Gbs1"),E=n("1iCU"),C=n("6XO9"),x=a(n("PYuP"))
n("cWnZ")
var g=window.MBServer,_="file:"===location.protocol?"https://".concat(g):"https://".concat(location.host),k=[{value:"highlight",label:I18N.highlight_clickable},{value:"wechat",label:I18N.view_in_browser}],T=function(e){function t(e){var i
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var C=a(n("pVnL")),x=a(n("J4zp")),o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("lSNA")),d=a(n("17x9")),_=r(n("q1tI")),k=a(n("vmbo")),T=n("/5+U"),f=function(e){function E(){return(0,o.default)(this,E),(0,c.default)(this,(0,u.default)(E).apply(this,arguments))}return(0,l.default)(E,e),(0,i.default)(E,[{key:"render",value:function(){var e=this.props,t=e.layer,n=e.parentRect,r=e.treeProps,a=t.width,o=t.height,i=t.top,c=t.left,u=t.z,l=t.childrenLayers
if(!1===t.v)return null
var s="layer"===t.kind?0:t.rotation||0,d=(0,T.getMinBoundingRect)({width:a,height:o,rotate:s,top:i,left:c}),f=(0,x.default)(d,4),p=f[0],h=f[1],m=f[2],v=f[3],g={top:i,left:c,width:a,height:o},y=h,b=m,w=v,S={top:(p-n.top)/n.height*100+"%",left:(y-n.left)/n.width*100+"%",width:b/n.width*100+"%",height:w/n.height*100+"%",zIndex:u||0}
return _.default.createElement("div",{"data-id":t.id,className:"layer-tree-node",style:S},_.default.createElement(k.default,(0,C.default)({layer:t},r)),l&&0<l.length&&l.map(function(e){return _.default.createElement(E,{key:e.id,layer:e,parentRect:g,treeProps:r})}))}}]),E}(_.Component)
...
n("edRh"),n("Xgir"),n("fRjM"),n("4MIG"),n("rXnp"),n("HLqo"),n("2rXa"),n("dSX7")},TAZq:function(e,t,n){e.exports=function(){"use strict"
return function(s){function d(e){if(e)try{s(e+"}")}catch(e){}}return function(e,t,n,r,a,o,i,c,u,l){switch(e){case 1:if(0===u&&64===t.charCodeAt(0))return s(t+";"),""
break
case 2:if(0===c)return t+"/*|*/"
break
case 3:switch(c){case 102:case 112:return s(n[0]+t),""
default:return t+(0===l?"/*|*/":"")}case-2:t.split("/*|*/}").forEach(d)}}}}()},TKrE:function(e,t){e.exports=function(e){return e}},TSYQ:function(e,t,n){var r
!function(){"use strict"
...
a&&e.push(a)}else if("object"===r)for(var o in n)i.call(n,o)&&n[o]&&e.push(o)}}return e.join(" ")}e.exports?(c.default=c,e.exports=c):void 0===(r=function(){return c}.apply(t,[]))||(e.exports=r)}()},TZdj:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var i=r(n("J4zp"))},TjoA:function(e,t,n){e.exports={"distance-measurement-container":"_2TbNwe0FAvWhPAGx9pJhSc"}},UJpD:function(e,t,n){e.exports={detector:"p677pQqCIRS-SsEhJWgV4"}},UbMB:function(e,t,n){var r
!function(){"use strict"
...
else if("object"===r)for(var a in n)o.call(n,a)&&n[a]&&e.push(this&&this[a]||a)}}return e.join(" ")}e.exports?(i.default=i,e.exports=i):void 0===(r=function(){return i}.apply(t,[]))||(e.exports=r)}()},UfWW:function(e,t,n){var o=n("KwMD"),i=n("ut/Y"),c=n("Sxd8"),u=Math.max
...
case 6:case"end":return e.stop()}},e,this)}))
return function(e,t){return n.apply(this,arguments)}}()
t.onFallbackError=l},VkAN:function(e,t){e.exports=function(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}},WVP6:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var g=r(n("MVZn")),y=r(n("J4zp")),o=r(n("lwsE")),i=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),l=r(n("7W2i")),s=r(n("PJYZ")),b=r(n("lSNA")),w=r(n("q1tI")),a=r(n("17x9")),d=n("1qiG"),f=function(e){function a(){var e,v;(0,o.default)(this,a)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return v=(0,c.default)(this,(e=(0,u.default)(a)).call.apply(e,[this].concat(n))),(0,b.default)((0,s.default)((0,s.default)(v)),"getDistanceMarksStyle",function(e,t){return{top:(0,d.toPercentage)(e.top/t.height),left:(0,d.toPercentage)(e.left/t.width),width:(0,d.toPercentage)(e.width/t.width),height:(0,d.toPercentage)(e.height/t.height)}}),(0,b.default)((0,s.default)((0,s.default)(v)),"mapDistanceMarks",function(e,t){var n,r=(0,y.default)(e,2),a=r[0],o=r[1],i=v.props,c=i.style,u=i.renderValue,
l=c.showStartAndEndBoundary,s=c.colorForLines,d=c.colorForText,f=c.backgroundColorForText,p=c.dashed,h=v.getMarkStyle(a,o),m=Math.abs(o)
return w.default.createElement("div",{key:"".concat(t,"-").concat(o)},w.default.createElement("div",{className:"distance-line ".concat(a),style:(0,g.default)({},h.line,(n={},(0,b.default)(n,["top","bottom"].includes(a)?"borderLeftStyle":"borderTopStyle",p?"dashed":"solid"),(0,b.default)(n,"borderColor",s),n))}),u?u({value:m,style:h.value,customClassName:"distance-value ".concat(a)}):w.default.createElement("span",{className:"distance-value ".concat(a),style:(0,g.default)({},h.value,{color:d,
backgroundColor:f})},m),l&&w.default.createElement(w.default.Fragment,null,w.default.createElement("div",{className:"distance-mark-start-boundary ".concat(a),style:{borderColor:s}}),w.default.createElement("div",{className:"distance-mark-end-boundary ".concat(a),style:(0,g.default)({},h.endBoundary,{borderColor:s})})))}),(0,b.default)((0,s.default)((0,s.default)(v)),"getMarkStyle",function(e,t){var n,r=v.props.baseRect,a={line:{},value:{},endBoundary:{}},o=["right","left"],i=o.includes(e
)?t/r.width:t/r.height
return a.line=(n={},(0,b.default)(n,e,t<0?0:(0,d.toPercentage)(-i)),(0,b.default)(n,o.includes(e)?"width":"height",(0,d.toPercentage)(Math.abs(i))),n),a.endBoundary=(0,b.default)({},e,(0,d.toPercentage)(-i)),a.value=(0,b.default)({},o.includes(e)?"left":"top",["right","bottom"].includes(e)?(0,d.toPercentage)(1+i/2):(0,d.toPercentage)(-i/2)),a}),v}return(0,l.default)(a,e),(0,i.default)(a,[{key:"render",value:function(){var e=this.props,t=e.baseRect,n=e.refRect,r=e.screen,a=(0,d.getDistancesForDirections)(t,n
),o=this.getDistanceMarksStyle(t,r)
return w.default.createElement("div",{className:"distance-marks",style:o},Object.entries(a).map(this.mapDistanceMarks))}}]),a}(w.default.Component);(t.default=f).propTypes={baseRect:a.default.object,refRect:a.default.object,screen:a.default.object,style:a.default.object,renderValue:a.default.func}},ZCpW:function(e,t,n){var r=n("lm/5"),a=n("O7RO"),o=n("IOzZ")
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),v=r(n("q1tI")),f=a(n("17x9")),p=a(n("i6OX")),h=a(n("QdB0")),g=a(n("6cfl")),y=a(n("DJvY")),b=a(n("DdUa")),w=a(n("l4l/")),S=a(n("2AqR")),E=a(n("6gQ3")),C=a(n("zgSj")),x=n("oose"),_=a(n("nQhf")),k=a(n("xUDz")),T=a(n("NyBV")),M=n("1iCU"),m=a(n("XpKX")),R=a(n("UbMB")).default.bind(m.default),N=window,I=N.MB,O=N.I18N,A=new Set(["ai@mockingbot.com","ethantw@me.com"]),P=function(e){function r(e){var t;(0,
o.default)(this,r),t=(0,c.default)(this,(0,u.default)(r).call(this,e)),(0,d.default)((0,s.default)((0,s.default)(t)),"handleClick",function(){F(),t.setState({showLoadtip:!1})})
var n=e.dispatch
...
if(t)return v.default.createElement(v.default.Fragment,null,v.default.createElement(b.default,null),v.default.createElement(_.default,null))
var u=o.toolbarActiveItem,l=o.isFullScreenMode,s=u==M.PREVIEW,d=u==M.INSPECT,f=u==M.COMMENT,p=!I.isElectron()&&!I.isHTMLZip()&&d&&c&&B(),h=!a&&s&&(A.has(r)||i),m=R({"is-offline-mode":I.isHTMLZip(),"is-uichina":I.isUIChina()||I.isForum(),"full-screen":l})
return v.default.createElement("div",{className:m},v.default.createElement(S.default,null),l&&v.default.createElement(k.default,null),d&&v.default.createElement(w.default,null),v.default.createElement("div",{className:R("adjust-container","preview-content-container")},f&&v.default.createElement(x.CommentContainer,null),d&&v.default.createElement(C.default,null),v.default.createElement(y.default,null),v.default.createElement(g.default,null),v.default.createElement(E.default,null)),h||I.isUIChina(
)&&v.default.createElement("a",{className:"powered-by",href:"/",target:"_blank"},v.default.createElement("img",{className:"zh",src:"/images/preview/watermark_zh.svg",alt:O.preview.powered_by_modao}),v.default.createElement("img",{className:"en",src:"/images/preview/watermark_en.svg",alt:O.preview.powered_by_modao})),v.default.createElement(j,{isActive:p,onClick:this.handleClick}),s&&v.default.createElement(T.default,null),v.default.createElement(_.default,null))}}]),r}(v.Component)
t.default=P,(0,d.default)(P,"propTypes",{isLite:f.default.bool,project:f.default.object,previewSetting:f.default.object,isProjectFromOtherFreeUser:f.default.bool,dispatch:f.default.func})
var j=function(e){var t=e.isActive,n=e.onClick
return t?v.default.createElement("div",{className:"download-client-tip"},v.default.createElement(p.default,{type:"fa",name:"info-circle",className:"download-client-tip-icon"}),v.default.createElement("span",{className:"download-text"},v.default.createElement("a",{href:"/downloads",rel:"noopener noreferrer",target:"_blank"},O.preview.client_load_a)," ",O.preview.client_load_tip),v.default.createElement(p.default,{type:"dora",name:"times_fc",className:"download-client-close-icon",onClick:n})):null}
...
return(0,x.setProjectCommentPermission)({allowComment:!(t.combo||t.template)&&t.limitation.commentable,denyMessage:I.renewMsg("cant_comment",{role:n?t.team_cid?"team":"project":"user"})})},D="close_client_load_tip",B=function(){return!I.localStorageDelegate.getItem(D)},F=function(){return I.localStorageDelegate.setItem(D,"true")}},a1Ia:function(e,t,n){e.exports={"sub-toolbar":"_1_GW4ZPKsACMqmFUgNIiea","select-input":"_1z2tl9KzoQhfo9Vd0AnQNl"}},aFF0:function(e,t,n){"use strict"
...
var y=function(e){var t=e.language,n=e.code,a=S(t),o=E(t),r=x(n)
...
"textLayer.attributedText = textString")),g},x=function(e){if(e["border-color"]&&e["border-width"]){var t={border:"".concat(e["border-width"]," solid ").concat(e["border-color"])}
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var w=r(n("MVZn")),a=n("/MKj"),S=r(n("J2m7")),o=r(n("KHYK")),i=(0,a.connect)(function(e){return(0,w.default)({},(o=(t=e).container,i=o.layers,c=i.resourceByScreen,u=i.visibilityScreenID,l=i.activeLayerID,s=i.enteredLayerID,d=o.previewSetting,f=d.ratio,p=d.unit,h=t.model,m=h.current.screenCid,v=h.screens,g=c[u],y=!1,b=p,g&&(n=(0,S.default)(g.layers,function(e){return e.id===l}),r=(0,S.default)(g.layers,function(e){return e.id===s}),n&&r&&r.id!==n.id&&(y=!0,a=v.find(function(e){return e.cid===m}))),{show:y,
ratio:f,distanceUnit:b,selectedLayer:n,hoveringLayer:r,screen:a}))
var t,n,r,a,o,i,c,u,l,s,d,f,p,h,m,v,g,y,b})(o.default)
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=r(n("VkAN")),l=r(n("q1tI")),o=r(n("17x9")),i=r(n("vOnD")),s=n("/5+U")
function c(){var e=(0,a.default)(["\n  padding: 0 5px;\n  color: #fff;\n  background-color: #ff7100;\n  border-radius: 2px;\n"])
return c=function(){return e},e}var u=function(e){var t=e.value,n=e.ratio,r=e.valueRatio,a=e.unit,o=e.style,i=e.className,c=e.customClassName,u=(0,s.adapterScreen)(t,n)
return l.default.createElement("div",{style:o,className:"".concat(i," ").concat(c)},"".concat(Math.round(u*r)).concat(a))},d=(0,i.default)(u)(c())
u.propTypes={value:o.default.oneOfType([o.default.string,o.default.number]),ratio:o.default.number,valueRatio:o.default.number,unit:o.default.string,style:o.default.object,className:o.default.string,customClassName:o.default.string}
var f=d
t.default=f},deeV:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),g=r(n("q1tI")),f=a(n("17x9")),p=a(n("zkrS")),h=n("6XO9"),m=n("CLzH"),v=n("H5Dy"),y=n("/5+U"),b=a(n("qES3")),w=n("hkZD"),S=a(n("UbMB")),E=a(n("mquD")),C=S.default.bind(E.default),x=function(e){function r(e){var l;(0,o.default)(this,r),l=(0,c.default)(this,(0,u.default)(r).call(this,e)),(0,d.default)((0,s.default)((0,s.default)(l)),"autoTextareaFocus",function(){return setTimeout(function(){
...
p.default.I18N.preview.comment.thread_create),"not_signin"===u&&g.default.createElement(h.Button,{className:E.default.login,onClick:_},p.default.I18N.preview.comment.tip_signin),"not_collaborator"===u&&g.default.createElement("span",null,p.default.I18N.preview.comment.tip_not_collaborator))})
...
t.default=x,(0,d.default)(x,"propTypes",{commentContainer:f.default.object,currentState:f.default.object,collaboratorsState:f.default.array,unreadCommentState:f.default.object,commentThreadList:f.default.array,selectCommentThread:f.default.object,commentListMap:f.default.object,currentScreenName:f.default.string,userId:f.default.number,dispatch:f.default.func})
var _=function(){window.location.href="/signin?next=".concat(window.location.pathname)},k="用户已退出协作",T="/images/avatar.png",M=function(e){return e&&setTimeout(function(){return e.scrollTop=e.scrollHeight-e.offsetHeight},0)},R=(0,y.immutableTransformCache)(function(e,n,r){return e.reduce(function(e,t){return t.project_cid!==n&&t.team_cid!==r||(e[t.user_id]=t),e},{})})},dppN:function(e,t,n){},dt0z:function(e,t){e.exports=function(e){return e}},e5cp:function(e,t,n){var g=n("fmRc"),y=n("or5M"),b=n("HDyB"),w=n(
"seXi"),S=n("QqLw"),E=n("Z0cm"),C=n("DSRE"),x=n("c6wG"),_="[object Arguments]",k="[object Array]",T="[object Object]",M=Object.prototype.hasOwnProperty
e.exports=function(e,t,n,r,a,o){var i=E(e),c=E(t),u=i?k:S(e),l=c?k:S(t),s=(u=u==_?T:u)==T,d=(l=l==_?T:l)==T,f=u==l
if(f&&C(e)){if(!C(t))return!1
s=!(i=!0)}if(f&&!s)return o||(o=new g),i||x(e)?y(e,t,n,r,a,o):b(e,t,u,n,r,a,o)
...
var y=(0,m.muteEvent)(),b={mouseup:y,mousedown:y,mousemove:y,mouseleave:y,mouseout:y,click:y,dblclick:y},w=225},fRjM:function(e,t,n){},fSKh:function(e,t,n){},flWF:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var u=a(n("o0o1")),o=a(n("yXPU")),c=a(n("lwsE")),i=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),h=a(n("17x9")),m=r(n("q1tI")),v=n("/MKj"),g=a(n("sEfC")),y=n("6XO9"),b=a(n("i6OX")),w=a(n("prTy")),S=a(n("UbMB")),E=a(n("2s0x")),C=n("/5+U"),x=n("Nu6V"),_=S.default.bind(E.default),k=!1,T=function(e){function a(e){var i;(0,c.default)(this,a),i=(0,l.default)(this,(0,s.default)(a).call(this,e)),(0,p.default)((0,f.default)((0,f.default)(i)),"handleActiveLayer",function(e){
...
case 3:return i.startLoadSlice(),e.next=6,P(n,r)
...
return o||a?m.default.createElement(O,null):0===r.length?m.default.createElement(A,null):m.default.createElement("div",{className:_("slice-container")},r.map(function(e){var t=e.name,n=e.id,r=e.screen_cid,a=e.image,o=e.image_set
...
r.imageRef=function(e){return r.$image=e},r.delaySingleDownload=(0,g.default)(function(){var e=r.props,t=e.imageSet,n=e.name;(0,C.downloadWithATag)({url:t,name:n,type:"zip"}),MB.event("在切图列表中下载单张切图","运行页")},500,{leading:!0}),r}return(0,d.default)(t,e),(0,i.default)(t,[{key:"render",value:function(){var e=this.props,t=e.name,n=e.src,r=e.activeLayerId,a=e.id,o=this.state,i=o.imageLoad,c=o.loadSingleSlice,u=i?"opacity-1":"opacity-0",l={display:i?"block":"none"},s=_("slice-item",{active:r===a})
...
return m.default.createElement(y.Tooltip,{content:{click:r},type:"block",position:"top",arrowed:!1,className:_("download"),onClick:t},I18N.preview_panel.download,n?m.default.createElement(I,null):m.default.createElement(b.default,{type:"dora",name:"export",className:_("icon-download")}))}
R.propTypes={onClick:h.default.func,isLoading:h.default.bool,isLogin:h.default.bool}
var N=function(){return m.default.createElement("div",{className:_("layer-load")},m.default.createElement("span",{className:_("spinner")}))},I=function(){return m.default.createElement("div",{className:_("download-slice-load")},m.default.createElement(N,null))},O=function(){return m.default.createElement("div",{className:_("slice-load-wrap")},m.default.createElement(N,null))},A=function(){return m.default.createElement("div",{className:_("no-slice")},m.default.createElement("img",{
src:"/images/preview/no-slice@2x.png"}),m.default.createElement("span",null,I18N.preview_panel.no_slice),m.default.createElement("span",null,I18N.preview_panel.slice_in_sketch),m.default.createElement("a",{href:"https://s3.cn-north-1.amazonaws.com.cn/modao/sketch/MockingBot.sketchplugin.zip"},m.default.createElement("img",{src:"/images/preview/ic_sketch@2x.png",alt:"sketch"}),I18N.preview_panel.download_sketch))},P=function(){var n=(0,o.default)(u.default.mark(function e(t,n){var r,a,o,i,c
return u.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:r=!0,o=1
...
f.PureComponent);(t.ReplyDropdown=_).propTypes={setReplyTextareaRef:p.default.func.isRequired,onValueChange:p.default.func.isRequired,doReply:p.default.func.isRequired,isReply:p.default.bool.isRequired}
...
return e.length>t}
var N=function(e){if(e){var t=e.getBoundingClientRect().bottom+I,n=document.getElementById("comment-thread"),r=n.scrollTop
n.scrollHeight<t+r?setTimeout(function(){return n.scrollTop=r+I},300):O<t&&(n.scrollTop=r+I)}},I=120,O=window.innerHeight},iETn:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var Oe=r(n("MVZn")),a=r(n("17x9")),Ae=r(n("q1tI")),Pe=n("qOCw"),je=n("Ro3d"),Le=n("PqLM"),De=n("RUem"),o=function(e){var t=e.layer,n=e.unit,r=e.ratio,a=e.showGlobal,o=e.userPickColor,i=void 0===o?[]:o,c=e.globalColor,u=void 0===c?[]:c,l=e.globalText,s=void 0===l?[]:l,d=e.documentColor,f=void 0===d?[]:d,p=e.screenColor,h=void 0===p?[]:p,m=e.language,v=e.colorUnit,g=e.dispatch,y=t.src_left,b=t.src_top,w=t.src_width,S=t.src_height,E=t.origin_width,C=t.origin_height,x=t.bd_radius,_=t.line_height,k=t.bg_colors,
T=void 0===k?[]:k,M=t.borders,R=void 0===M?[]:M,N=t.i,I=t.display_name,O=t.padding,A=void 0===O?0:O,P=t.hiddSpacing,j=void 0!==P&&P,L=t.text_styles,D=void 0===L?[]:L,B=t.alignment,F=t.vertical_alignment,U=t.image,q=t.text,W=t.letter_spacing,H=t.image_set_zip,z=t.shadows,V=void 0===z?[]:z,Y=t.inner_shadows,Z=void 0===Y?[]:Y,J=t.rotation,X=t.textShadows,G=void 0===X?[]:X,K=t.image_set,Q=void 0===K?[]:K,$=t.name,ee=0<R.length,te=0<T.length,ne=!!U,re=0<D.length&&q&&(0,Pe.getTextContent)(t).length,
ae=0<V.length||0<G.length,oe=0<Z.length,ie=H,ce={left:y,top:b,width:E||w,height:C||S,borderRadius:x,opacity:t.o,rotation:J,ratio:r,unit:n}
if("line"===$){var ue=(0,Le.getLineGeneralInfo)(t,!0),le=ue.length,se=ue.thickness,de=ue.angle
ce.width=le,ce.height=se,ce.rotation=de}var fe=(0,Pe.getBaseAttributes)(ce),pe=fe.adapterTop,he=fe.adapterLeft,me=fe.adapterWidth,ve=fe.adapterHeight,ge=fe.radius,ye=fe.opacity,be=fe.rotate,we={lineHeight:_,letterSpacing:W,unit:n,ratio:r},Se=(0,Pe.getTextAttributes)(we),Ee=Se.lineHeight,Ce=Se.letterSpacing,xe="number"==typeof N?N?"italic":"normal":void 0,_e={textStyles:D,background:T,borders:R,shadows:V,innerShadows:Z,colorUnit:v,ratio:r,unit:n},ke=(0,Pe.getCodeAttributes)(_e),Te=t.o&&100!=t.o?t.o/100:null,
Me=(0,je.transfromProptype)({attr:(0,Oe.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:B,opacity:Te,borderRadius:ge},ke),language:m,unit:n}),Re=ne?"ImageView":re?"TextView":"View",Ne="screen"===t.type||t.kind?t.name:I,Ie="line"===t.name
return a?Ae.default.createElement(De.GlobalAttributes,{adapterWidth:me,adapterHeight:ve,documentColor:f,globalText:s,globalColor:u,screenColor:h,userPickColor:i,colorUnit:v,dispatch:g}):Ae.default.createElement("div",null,Ae.default.createElement(De.LayerName,{value:Ne}),Ae.default.createElement(De.BasicAttributes,{adapterTop:pe,adapterLeft:he,adapterWidth:me,adapterHeight:ve,rotate:be,radius:ge,opacity:ye,unit:n,colorUnit:v}),re&&Ae.default.createElement(De.TextLayerInfo,{textStyles:D,alignment:B,
vertical_alignment:F,lineHeight:Ee,letterSpacing:Ce,ratio:r,unit:n,o:t.o,padding:A,fontStyle:xe,colorUnit:v,hiddSpacing:j,text:(0,Pe.getTextContent)(t)}),te&&Ae.default.createElement(De.Fills,{backgroundColorSort:T,colorUnit:v}),ee&&Ae.default.createElement(De.BorderInfo,{isStroke:Ie,borderSort:R,ratio:r,unit:n,colorUnit:v}),ae&&Ae.default.createElement(De.Shadows,{shadows:V,textShadows:G,colorUnit:v,unit:n,ratio:r}),oe&&Ae.default.createElement(De.Shadows,{shadows:Z,colorUnit:v,unit:n,ratio:r,
isInnerShaow:!0}),ie&&Ae.default.createElement(De.ImageInfo,{imageSetZip:H,name:t.display_name,imageSet:Q}),Ae.default.createElement(De.CodeBox,{code:Me,whichAndView:Re,language:m,text:(0,Pe.getTextContent)(t)||""}))}
...
if(t&&x([],e,function(e){return n.push(a(e))}),n.length){var r="".concat(t,"|").concat(y(e),"|").concat(b(e))
...
var E=/url\([^)]*\)/g,C=r(E,c),x=r(E,/(\/?(\.?\.\/)*\b[-\w@:%_+.~#?&\/=]+.(woff2|woff|ttf|svg))([?#][-\w%._#=]{1,256})?/)
t.createCSSFragCollector=function(){return n({extractorList:[C,x],trimComment:function(e){return e.replace(o,"")}})}},knB1:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=v,(0,f.default)(v,"propTypes",{className:h.default.string,menuClassName:h.default.string})},mCdf:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var l=r(n("MVZn")),o=r(n("lwsE")),i=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),s=r(n("7W2i")),d=r(n("PJYZ")),p=r(n("lSNA")),f=r(n("q1tI")),a=r(n("17x9")),h=n("1qiG"),m=function(e){function a(){var e,f;(0,o.default)(this,a)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return f=(0,c.default)(this,(e=(0,u.default)(a)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)((0,d.default)(f)),"getAuxiliaryLinesStyle",function(e,t){return{top:(0,h.toPercentage)(e.top/t.height),left:(0,h.toPercentage)(e.left/t.width),width:(0,h.toPercentage)(e.width/t.width),height:(0,h.toPercentage)(e.height/t.height)}}),(0,p.default)((0,d.default)((0,d.default)(f)),"getAuxiliaryLinesLength",function(){var e={},t=f.props,n=t.baseRect,r=t.refRect,a=(0,h.getMinContainingRect)(n,r),
o=a.width-r.width
0<a.height-(n.height+r.height)&&o>n.width/2&&(e.horizontal=o)
var i=a.height-r.height
return 0<a.width-(n.width+r.width)&&i>n.height/2&&(e.vertical=i),e}),(0,p.default)((0,d.default)((0,d.default)(f)),"getLineStyle",function(e,t){var n=f.props,r=n.baseRect,a=n.refRect,o=r.left>a.left,i=r.top>a.top,c={}
if(e){var u,l=e/a.width
c.horizontal=(u={},(0,p.default)(u,i?"bottom":"top",0),(0,p.default)(u,o?"right":"left",(0,h.toPercentage)(-l)),(0,p.default)(u,"width",(0,h.toPercentage)(l)),u)}if(t){var s,d=t/a.height
c.vertical=(s={},(0,p.default)(s,o?"right":"left",0),(0,p.default)(s,i?"bottom":"top",(0,h.toPercentage)(-d)),(0,p.default)(s,"height",(0,h.toPercentage)(d)),s)}return c}),f}return(0,s.default)(a,e),(0,i.default)(a,[{key:"render",value:function(){var e=this.props,t=e.refRect,n=e.screen,r=e.style,a=this.getAuxiliaryLinesLength(),o=a.horizontal,i=a.vertical
if(!o&&!i)return null
var c=this.getAuxiliaryLinesStyle(t,n),u=this.getLineStyle(o,i)
return f.default.createElement("div",{className:"smart-auxiliary-lines",style:c},o&&f.default.createElement("div",{className:"line horizontal",style:(0,l.default)({},u.horizontal,{borderTopStyle:"".concat(r.dashed?"dashed":"solid"),borderTopColor:r.colorForLines})}),i&&f.default.createElement("div",{className:"line vertical",style:(0,l.default)({},u.vertical,{borderLeftStyle:"".concat(r.dashed?"dashed":"solid"),borderLeftColor:r.colorForLines})}))}}]),a}(f.default.Component);(t.default=m).propTypes={
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var R=a(n("MVZn")),o=a(n("lwsE")),i=a(n("W8MJ")),c=a(n("a1gu")),u=a(n("Nsbk")),l=a(n("7W2i")),s=a(n("lSNA")),d=a(n("17x9")),N=r(n("q1tI")),I=n("0k54"),O=a(n("jybS")),A=a(n("3jXG")),P=new Set(["pg","sticky","lr","webpage"]),f=function(e){function M(){return(0,o.default)(this,M),(0,c.default)(this,(0,u.default)(M).apply(this,arguments))}return(0,l.default)(M,e),(0,i.default)(M,[{key:"render",value:function(){var e=this.props,t=e.treeData,n=e.offSetX,r=e.offSetY,a=e.isSnapshot,o=t.cid,i=t.type,c=t.children,
u=t.widget
if(a&&P.has(u.name))return null
var l=(0,I.getTreeBoundingRect)(t),s=l.minX,d=l.minY,f=l.maxX,p=l.maxY,h=d-r,m=s-n
if("group"!==i)return"panel"===i?N.default.createElement(A.default,{treeData:t,top:h,left:m,isSnapshot:a}):N.default.createElement(O.default,{widget:u,postfix:"p",top:h,left:m})
...
g="group",!MB.isPhantom()&&"none"!=v.ani_name&&v.v&&(g+=" animated ".concat(v.ani_name)),Link.exists(v.link_cids)&&(g+=" clickable"),v.v||(g+=" invisible"),g),_=Link.exists(u.link_cids)?u.link_cids:"",k=u.v&&Link.find(u.link_cids),T=k&&"tap"!==k.gesture?k.gesture:""
return N.default.createElement("div",{"data-cid":o,"data-link_cid":_,className:x,style:C},c.map(function(e){return N.default.createElement(M,{key:e.cid,treeData:e,offSetX:s,offSetY:d,isSnapshot:a})}),N.default.createElement("div",{className:"region gesture ".concat(T)}))}}]),M}(N.PureComponent)
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var x=a(n("pVnL")),c=a(n("MVZn")),u=a(n("lwsE")),o=a(n("W8MJ")),l=a(n("a1gu")),s=a(n("Nsbk")),d=a(n("7W2i")),f=a(n("PJYZ")),p=a(n("lSNA")),_=r(n("q1tI")),i=a(n("17x9")),k=a(n("i6OX")),T=a(n("zkrS")),M=n("hkZD"),R=n("iETn"),N=a(n("mquD")),h=a(n("UbMB")),m=n("l0oT"),I=h.default.bind(N.default),v=function(e){function i(e){var a;(0,u.default)(this,i),a=(0,l.default)(this,(0,s.default)(i).call(this,e)),(0,p.default)((0,f.default)((0,f.default)(a)),"handleSetting",function(e){0==Number(e)&&(a.toggleEditing(),
...
g=t[0]||null,y=g&&c.getCollaborator(g.user_id),b=t.slice(1)||[],w=2<b.length,S=t.length,E="".concat(N.default.comment," thread-initial entry ").concat(l?"":null==u?"":I(v?"comment-focus":"comment-noFocus")),C=(0,M.ifCanReply)({userId:n,currentState:r,permission:o})
return 0==S?null:_.default.createElement("div",{ref:this.setCommentRef,className:E,onMouseEnter:this.toggleSelect,onMouseLeave:this.cancelSelect},_.default.createElement("div",null,_.default.createElement(M.ContentHeader,{markIndex:i,onSelect:this.handleSetting,onDelete:this.doDeleteThread,permission:o,information:y,ifShowBtn:!h,showByEnter:m}),_.default.createElement("div",{className:I("container-main")},g&&_.default.createElement(M.ContentMessage,{permission:o,comment:g,isFolded:p,isEdit:h,
toggleEdit:this.toggleEditing,getValue:this.getCommentMessage,setEditableSpanComponent:this.setEditableSpanComponent,onValueChange:this.doUpdateComment}),!this.state.isEdit&&_.default.createElement("div",{className:"".concat(I("container-bottom"))},g&&_.default.createElement("div",{className:N.default.time},T.default.L10N.parseTimeAgo(1e3*g.updated_at)),C&&_.default.createElement("div",{className:I("reply-sort"),onClick:this.toggleReply},_.default.createElement(k.default,{type:"dora",name:"reply",
className:I("btn-reply")}),d?T.default.I18N.preview.comment.cancel_reply:T.default.I18N.preview.comment.comment_create)))),_.default.createElement(M.ReplyDropdown,{isReply:d,doReply:this.doReply,onValueChange:this.doCreateComment,setReplyTextareaRef:this.setReplyTextareaRef}),w?_.default.createElement(R.CommentReplyEntry,(0,x.default)({doCreateComment:this.doCreateComment,replyList:b.slice(0,2)},this.props)):_.default.createElement(R.CommentReplyEntry,(0,x.default)({doCreateComment:this.doCreateComment,
replyList:b},this.props)),f&&_.default.createElement(R.CommentReplyEntry,(0,x.default)({doCreateComment:this.doCreateComment,replyList:b.slice(2)},this.props)),w&&_.default.createElement("div",{className:N.default.expand,onClick:this.handleRenderMoreComments},f?I18N.preview.comment.fold:I18N.preview.comment.unfold))}}]),i}(_.PureComponent)
...
t=y&&(0,T.getNormalRgbaColor)(y),n=(0,k.adapterScreen)(b,v,m),r=w}if(d.length){var S=d[0],E=S.position,C=void 0===E?"inside":E,x=S.color,_=S.thickness
a=(0,k.adapterScreen)(_,v,m),i=C,x&&(o=(0,T.getNormalRgbaColor)(x))}return f.length&&(c=(0,T.getNormalRgbaColor)(f[0].value)),p.length&&(u=M(p,m,v)),h.length&&(l=M(h,m,v,!0),u="".concat(u,", ").concat(l)),{fontFamily:r,fontSize:n,color:t,borderWidth:a,borderColor:o,borderPosition:i,backgroundColor:c,boxShadow:u}}
...
e.exports=function(t){return function(e){return r(o(a(e).replace(i,"")),t,"")}}},"t5S/":function(e,t,n){var R=n("87hQ"),N=n("RNpe"),I=n("kUAk"),O=n("/MKq")
...
var i,l=(i=r(regeneratorRuntime.mark(function e(t){var n,r,a,o,i,c,u,l,s,d,f,p,h,m,v,g,y,b,w,S,E,C,x,_,k,T,M
...
case 5:c=(0,I.createHTMLFragCollector)(),n.forEach(function(e){return c.collect(e,"")}),u=(0,I.createCSSFragCollector)(),l=Array.from(document.getElementsByTagName("link")).map(function(e){return"stylesheet"===e.rel&&e.href}).filter(function(e){return e}),d=!(s=!0),f=void 0,e.prev=12,p=l[Symbol.iterator]()
...
case 39:return Array.from(document.getElementsByTagName("style")).map(function(e){return u.collect(e.innerHTML,"")}),v=c.getOutput(),g=u.getOutput(),y=new Set(A(v.fontInfo.fontFamilySet).concat(A(g.fontInfo.fontFamilySet))),Object.entries(Object.assign({},v.fontInfo.fontFaceMap,g.fontInfo.fontFaceMap)).forEach(function(e){var t,n,r=(n=2,function(e){if(Array.isArray(e))return e}(t=e)||function(e,t){var n=[],r=!0,a=!1,o=void 0
...
var u=!1
o.forEach(function(e){i&&e!==i?e.isIgnore=!0:c&&e!==c?e.isIgnore=!0:(e.isIgnore=u,u=!0)})}),T=function(){return{htmlString:b,cssString:w,domString:S,svgString:E,svgDataUrl:C,imageElement:x,canvasElement:_,pngDataUrl:k}},e.prev=46,e.t4=O.prepareHTMLString,e.next=50,(0,N.convertFragListWithUrlMap)(v)
case 50:return e.t5=e.sent,e.next=53,(0,e.t4)(e.t5)
case 53:return b=e.sent,e.t6=O.prepareCSSString,e.next=57,(0,N.convertFragListWithUrlMap)(g)
case 57:return e.t7=e.sent,e.next=60,(0,e.t6)(e.t7)
case 60:return w=e.sent,S="".concat(w,"\n").concat(b),e.next=64,(0,O.prepareSVGString)({domString:S,width:r,height:a})
case 64:if(E=e.sent,C="data:image/svg+xml;charset=utf8,".concat(encodeURIComponent(E)),i){e.next=73
break}return e.next=69,P({svgDataUrl:C,width:r,height:a})
case 69:M=e.sent,x=M.imageElement,_=M.canvasElement,k=M.pngDataUrl
case 73:e.next=78
break
...
var c,P=(c=r(regeneratorRuntime.mark(function e(t){var n,r,a,o,i,c
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.svgDataUrl,r=t.width,a=t.height,e.next=3,(0,O.prepareImageElement)({svgDataUrl:n,width:r,height:a})
case 3:return o=e.sent,e.next=6,(0,O.prepareCanvasElement)({imageElement:o,width:r,height:a})
...
t.renderPngDataUrlFromSvgDataUrl=P},t77w:function(e,t,n){"use strict"
var r=n("TqRt")
...
n.d(t,"i",function(){return E}),n.d(t,"s",function(){return C}),n.d(t,"t",function(){return x}),n.d(t,"n",function(){return _}),n.d(t,"b",function(){return k}),n.d(t,"o",function(){return T}),n.d(t,"e",function(){return R}),n.d(t,"c",function(){return N}),n.d(t,"h",function(){return I}),n.d(t,"k",function(){return O}),n.d(t,"r",function(){return A}),n.d(t,"m",function(){return P}),n.d(t,"f",function(){return j}),n.d(t,"p",function(){return L}),n.d(t,"a",function(){return D}),n.d(t,"g",function(){return B}),
n.d(t,"j",function(){return F}),n.d(t,"l",function(){return U}),n.d(t,"q",function(){return q}),n.d(t,"d",function(){return H})
...
return S(l,M("call",e,n))}function N(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:[]
return S(l,M("apply",{context:e,fn:t},n))}function I(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return S(s,M("cps",e,n))}function O(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return S(d,M("fork",e,n))}function A(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return E(O.apply(void 0,[e].concat(n)))}function P(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
if(1<t.length)return k(t.map(function(e){return P(e)}))
var r=t[0]
return Object(i.h)(r,i.q.notUndef,"join(task): argument task is undefined"),Object(i.h)(r,i.q.task,"join(task): argument "+r+" is not a valid Task object "+w),S(f,r)}function j(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
if(1<t.length)return k(t.map(function(e){return j(e)}))
var r=t[0]
return 1===t.length&&(Object(i.h)(r,i.q.notUndef,"cancel(task): argument task is undefined"),Object(i.h)(r,i.q.task,"cancel(task): argument "+r+" is not a valid Task object "+w)),S(p,r||i.d)}function L(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
...
"actionChannel(pattern, buffer): argument "+t+" is not a valid buffer")),S(m,{pattern:e,buffer:t})}function B(){return S(v,{})}function F(e){return Object(i.h)(e,i.q.channel,"flush(channel): argument "+e+" is not valid channel"),S(g,e)}function U(e){return Object(i.h)(e,i.q.string,"getContext(prop): argument "+e+" is not a string"),S(y,e)}function q(e){return Object(i.h)(e,i.q.object,Object(i.k)(null,e)),S(b,e)}_.resolve=function(){var e=_.apply(void 0,arguments)
...
case"mcheckbox2":return m.default.createElement(x,{widget:e})
...
case"ve":return m.default.createElement(I,{widget:e})
case"triangleb":return m.default.createElement(O,{widget:e})
case"triangletl":return m.default.createElement(A,{widget:e})
case"lr":case"tab_bar":case"rectangle":return m.default.createElement(P,{widget:e})
case"image_view":return m.default.createElement(D,{widget:e})
...
case"iphone_keyboard":return m.default.createElement(F,{widget:e})
...
default:return null}}
var l=a(n("MVZn")),s=a(n("J4zp")),i=a(n("PJYZ")),d=a(n("lSNA")),c=a(n("lwsE")),u=a(n("W8MJ")),f=a(n("a1gu")),p=a(n("Nsbk")),h=a(n("7W2i")),m=r(n("q1tI")),o=r(n("m/km")),v=n("zQyp"),g=n("rQun"),y=n("G3NE")
var b=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return null}}]),t}(m.PureComponent),w=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=JSON.parse(e.text)
...
return m.default.createElement("textarea",{style:r,placeholder:e.text})}}]),t}(b),x=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("input",{type:"checkbox",checked:e.checked})}}]),t}(b),_=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("input",{type:"file"})}}]),t}(b),k=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",
...
return e<1&&(e=1),m.default.createElement("span",{style:{borderTopWidth:e}})}}]),t}(b),N=function(e){function o(){var e,t;(0,c.default)(this,o)
for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
m.default.createElement("i",{className:"fa fa-play-circle-o"}))}}]),t}(b),D=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=""
...
return m.default.createElement("img",{src:a,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),F=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.numeric?"n":"r",n=e.cs().orientation,r="".concat(MB.urlRootHTMLZip(),"images/keyboards/iphone_").concat(t,"_").concat(n,".png")
return m.default.createElement("img",{src:r,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),U=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.numeric?"n":"r",n=e.cs().orientation,r="".concat(MB.urlRootHTMLZip(),"images/keyboards/ipad_").concat(t,"_").concat(n,".png")
...
return m.default.createElement("label",{className:"iOS-Check"},m.default.createElement("input",{key:e.screenstate_cid+e.checked,type:"checkbox",defaultChecked:e.checked}),m.default.createElement("span",{className:"CheckState"},m.default.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"13",height:"8",viewBox:"0 0 13 8"},m.default.createElement("path",{d:"M1 4.5L4.5 8l8-8"}))))}}]),t}(b),K=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,
...
return m.default.createElement("p",{dangerouslySetInnerHTML:{__html:e}})}}]),t}(b),re=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t={padding:e.padding}
...
var a=e.slt-r,o={top:e.slt<=e.top-20?a:"",height:Math.abs(a)},i={top:a},c={top:r,width:e.slw,borderColor:n},u={left:t?"100%":"",right:t?"":"100%",backgroundColor:n},l={backgroundImage:"linear-gradient(135deg, ".concat(n," 25%, transparent 25%, transparent 100%), linear-gradient(45deg, transparent 75%, ").concat(n," 75%, ").concat(n," 100%)")}
...
){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e,t,n=this.props.widget,r={top:"borderBottomColor",bottom:"borderTopColor",left:"borderRightColor",right:"borderLeftColor"}[n.tt_placement],a="top"==n.tt_placement||"bottom"==n.tt_placement,o={borderWidth:n.tt_arrow_size,left:a?n.tt_offset:"",top:a?"":n.tt_offset},i=(0,l.default)({},o,(e={},(0,d.default)(e,n.tt_placement,0-n.tt_arrow_size),(0,
d.default)(e,r,n.bc||"#aaa"),e)),c=(0,l.default)({},o,(t={},(0,d.default)(t,n.tt_placement,0-n.tt_arrow_size+(0,v.getBorderWidth)(n)),(0,d.default)(t,r,n.bg||"white"),t)),u={padding:n.padding,marginTop:n.text&&"middle"===n.va?0-n.textHeight()/2:""}
...
case 9:case"end":return e.stop()}},e,this)}))
return function(e,t,n,r,a){return o.apply(this,arguments)}}(),C="/images/preview/image-load.png",x=function(e){function n(){var t
...
return m.default.createElement("img",{ref:this.setElementRef,src:r||C})}}]),n}(m.PureComponent);(t.default=x).propTypes={screenCid:h.default.string,version:h.default.string,imageUrl:h.default.string,screenName:h.default.string,canvasZoom:h.default.number,isVisible:h.default.bool}},vOnD:function(e,ct,ut){"use strict"
ut.r(ct),function(e,t){ut.d(ct,"css",function(){return F}),ut.d(ct,"keyframes",function(){return at}),ut.d(ct,"injectGlobal",function(){return ot}),ut.d(ct,"isStyledComponent",function(){return O}),ut.d(ct,"consolidateStreamedStyles",function(){return A}),ut.d(ct,"ThemeProvider",function(){return Re}),ut.d(ct,"withTheme",function(){return Be}),ut.d(ct,"ServerStyleSheet",function(){return pe}),ut.d(ct,"StyleSheetManager",function(){return fe}),ut.d(ct,"__DO_NOT_USE_OR_YOU_WILL_BE_HAUNTED_BY_SPOOKY_GHOSTS",
function(){return Fe})
var n=ut("+8Ar"),i=ut.n(n),d=ut("q1tI"),c=ut.n(d),r=ut("2q7i"),a=ut.n(r),o=ut("TAZq"),u=ut.n(o),l=ut("17x9"),s=ut.n(l),f=ut("2mql"),y=ut.n(f),p=ut("z6R5"),h="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},b=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},w=function(){function r(e,t){for(var n=0;n<t.length;n++){
var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(e,t,n){return t&&r(e.prototype,t),n&&r(e,n),e}}(),S=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},E=function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)},C=function(e,t){var n={}
for(var r in e)0<=t.indexOf(r)||Object.prototype.hasOwnProperty.call(e,r)&&(n[r]=e[r])
return n},x=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
return!t||"object"!=typeof t&&"function"!=typeof t?e:t},m=function(e){return"object"===(void 0===e?"undefined":h(e))&&e.constructor===Object}
var _=function(o){function i(e){b(this,i)
for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
var a=x(this,o.call(this,"An error occurred. See https://github.com/styled-components/styled-components/blob/master/src/utils/errors.md#"+e+" for more information. "+(n?"Additional arguments: "+n.join(", "):"")))
return x(a)}return E(i,o),i}(Error),v=function a(e,o){return e.reduce(function(e,t){if(null==t||!1===t||""===t)return e
if(Array.isArray(t))return e.push.apply(e,a(t,o)),e
if(t.hasOwnProperty("styledComponentId"))return e.push("."+t.styledComponentId),e
if("function"!=typeof t)return e.push(m(t)?function t(n,e){var r=Object.keys(n).filter(function(e){var t=n[e]
return null!=t&&!1!==t&&""!==t}).map(function(e){return m(n[e])?t(n[e],e):i()(e)+": "+n[e]+";"}).join(" ")
return e?e+" {\n  "+r+"\n}":r}(t):t.toString()),e
if(o){var n=t(o)
if(c.a.isValidElement(n)){var r=t.displayName||t.name
throw new _(11,r)}e.push.apply(e,a([n],o))}else e.push(t)
return e},[])},g=/^\s*\/\/.*$/gm,k=new a.a({global:!1,cascade:!0,keyframe:!1,prefix:!1,compress:!1,semicolon:!0}),T=new a.a({global:!1,cascade:!0,keyframe:!1,prefix:!0,compress:!1,semicolon:!1}),M=[],R=function(e){if(-2===e){var t=M
return M=[],t}},N=u()(function(e){M.push(e)})
T.use([N,R]),k.use([N,R])
var I=function(e,t,n){var r=e.join("").replace(g,"")
return T(n||!t?"":t,t&&n?n+" "+t+" { "+r+" }":r)}
function O(e){return"function"==typeof e&&"string"==typeof e.styledComponentId}function A(){0}var P=function(e){return String.fromCharCode(e+(25<e?39:97))},j=function(e){var t="",n=void 0
for(n=e;52<n;n=Math.floor(n/52))t=P(n%52)+t
return P(n%52)+t},L=function(e,t){for(var n=[e[0]],r=0,a=t.length;r<a;r+=1)n.push(t[r],e[r+1])
return n},D=Object.freeze([]),B=Object.freeze({}),F=function(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return"function"==typeof e||m(e)?v(L(D,[e].concat(n))):v(L(e,n))},U=void 0!==e&&e.env.SC_ATTR||"data-styled-components",q="data-styled-streamed",W="__styled-components-stylesheet__",H="undefined"!=typeof window&&"HTMLElement"in window,z=/^[^\S\n]*?\/\* sc-component-id:\s*(\S+)\s+\*\//gm,V=function(e){var o=""+(e||""),i=[]
return o.replace(z,function(e,t,n){return i.push({componentId:t,matchIndex:n}),e}),i.map(function(e,t){var n=e.componentId,r=e.matchIndex,a=i[t+1]
return{componentId:n,cssFromDOM:a?o.slice(r,a.matchIndex):o.slice(r)}})},Y=function(){return ut.nc},Z=function(e,t,n){n&&((e[t]||(e[t]=Object.create(null)))[n]=!0)},J=function(e,t){e[t]=Object.create(null)},X=function(n){return function(e,t){return void 0!==n[e]&&n[e][t]}},G=function(e){var t=""
for(var n in e)t+=Object.keys(e[n]).join(" ")+" "
return t.trim()},K=function(e){if(e.sheet)return e.sheet
for(var t=document.styleSheets.length,n=0;n<t;n+=1){var r=document.styleSheets[n]
if(r.ownerNode===e)return r}throw new _(10)},Q=function(e,t,n){if(!t)return!1
var r=e.cssRules.length
try{e.insertRule(t,n<=r?n:r)}catch(e){return!1}return!0},$=function(e){return"\n/* sc-component-id: "+e+" */\n"},ee=function(e,t){for(var n=0,r=0;r<=t;r+=1)n+=e[r]
return n},te=function(n,r){return function(e){var t=Y()
return"<style "+[t&&'nonce="'+t+'"',U+'="'+G(r)+'"',e].filter(Boolean).join(" ")+">"+n()+"</style>"}},ne=function(r,a){return function(){var e,t=((e={})[U]=G(a),e),n=Y()
return n&&(t.nonce=n),c.a.createElement("style",S({},t,{dangerouslySetInnerHTML:{__html:r()}}))}},re=function(e){return function(){return Object.keys(e)}},ae=function r(e,t){var a=void 0===e?Object.create(null):e,o=void 0===t?Object.create(null):t,i=function(e){var t=o[e]
return void 0!==t?t:o[e]=[""]},n=function(){var e=""
for(var t in o){var n=o[t][0]
n&&(e+=$(t)+n)}return e}
return{clone:function(){var e=function(e){var t=Object.create(null)
for(var n in e)t[n]=S({},e[n])
return t}(a),t=Object.create(null)
for(var n in o)t[n]=[o[n][0]]
return r(e,t)},css:n,getIds:re(o),hasNameForId:X(a),insertMarker:i,insertRules:function(e,t,n){i(e)[0]+=t.join(" "),Z(a,e,n)},removeRules:function(e){var t=o[e]
void 0!==t&&(t[0]="",J(a,e))},sealed:!1,styleTag:null,toElement:ne(n,a),toHTML:te(n,a)}},oe=function(e,t,n,r,a){if(!H||n)return ae()
var f,p,h,c,m,v,g,y,o,i=function(e,t,n){var r=document.createElement("style")
r.setAttribute(U,"")
var a=Y()
if(a&&r.setAttribute("nonce",a),r.appendChild(document.createTextNode("")),e&&!t)e.appendChild(r)
else{if(!t||!e||!t.parentNode)throw new _(6)
t.parentNode.insertBefore(r,n?t:t.nextSibling)}return r}(e,t,r)
return f=i,p=a,h=Object.create(null),c=Object.create(null),v=void 0!==p,g=!(m=[]),y=function(e){var t=c[e]
return void 0!==t?t:(c[e]=m.length,m.push(0),J(h,e),c[e])},{clone:function(){throw new _(5)},css:o=function(){var e=K(f).cssRules,t=""
for(var n in c){t+=$(n)
for(var r=c[n],a=ee(m,r),o=a-m[r];o<a;o+=1){var i=e[o]
void 0!==i&&(t+=i.cssText)}}return t},getIds:re(c),hasNameForId:X(h),insertMarker:y,insertRules:function(e,t,n){for(var r=y(e),a=K(f),o=ee(m,r),i=0,c=[],u=t.length,l=0;l<u;l+=1){var s=t[l],d=v
d&&-1!==s.indexOf("@import")?c.push(s):Q(a,s,o+i)&&(d=!1,i+=1)}v&&0<c.length&&(g=!0,p().insertRules(e+"-import",c)),m[r]+=i,Z(h,e,n)},removeRules:function(e){var t=c[e]
if(void 0!==t){var n=m[t]
!function(e,t,n){for(var r=t-n,a=t;r<a;a-=1)e.deleteRule(a)}(K(f),ee(m,t),n),m[t]=0,J(h,e),v&&g&&p().removeRules(e+"-import")}},sealed:!1,styleTag:f,toElement:ne(o,h),toHTML:te(o,h)}},ie=/\s+/,ce=void 0
ce=H?1e3:-1
var ue,le=0,se=void 0,de=function(){function r(){var n=this,e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:H?document.head:null,t=1<arguments.length&&void 0!==arguments[1]&&arguments[1]
b(this,r),this.getImportRuleTag=function(){var e=n.importRuleTag
if(void 0!==e)return e
var t=n.tags[0]
return n.importRuleTag=oe(n.target,t?t.styleTag:null,n.forceServer,!0)},le+=1,this.id=le,this.forceServer=t,this.target=t?null:e,this.tagMap={},this.deferred={},this.rehydratedNames={},this.ignoreRehydratedNames={},this.tags=[],this.capacity=1,this.clones=[]}return r.prototype.rehydrate=function(){if(!H||this.forceServer)return this
var e=[],t=[],n=!1,r=document.querySelectorAll("style["+U+"]"),a=r.length
if(0===a)return this
for(var o=0;o<a;o+=1){var i=r[o]
n||(n=!!i.getAttribute(q))
for(var c=(i.getAttribute(U)||"").trim().split(ie),u=c.length,l=0;l<u;l+=1){var s=c[l]
this.rehydratedNames[s]=!0}t.push.apply(t,V(i.textContent)),e.push(i)}var d=t.length
if(0===d)return this
var f,p,h,m,v,g,y=this.makeTag(null),b=(f=y,p=e,h=t,v=!(m=function(){for(var e=0,t=h.length;e<t;e+=1){var n=h[e],r=n.componentId,a=n.cssFromDOM,o=k("",a)
f.insertRules(r,o)}for(var i=0,c=p.length;i<c;i+=1){var u=p[i]
u.parentNode&&u.parentNode.removeChild(u)}}),g=function(){v||(v=!0,m())},n&&g(),S({},f,{insertMarker:function(e){return g(),f.insertMarker(e)},insertRules:function(e,t,n){return g(),f.insertRules(e,t,n)}}))
this.capacity=Math.max(1,ce-d),this.tags.push(b)
for(var w=0;w<d;w+=1)this.tagMap[t[w].componentId]=b
return this},r.reset=function(){var e=0<arguments.length&&void 0!==arguments[0]&&arguments[0]
se=new r(void 0,e).rehydrate()},r.prototype.clone=function(){var a=new r(this.target,this.forceServer)
return this.clones.push(a),a.tags=this.tags.map(function(e){for(var t=e.getIds(),n=e.clone(),r=0;r<t.length;r+=1)a.tagMap[t[r]]=n
return n}),a.rehydratedNames=S({},this.rehydratedNames),a.deferred=S({},this.deferred),a},r.prototype.sealAllTags=function(){this.capacity=1,this.tags.forEach(function(e){e.sealed=!0})},r.prototype.makeTag=function(e){var t=e?e.styleTag:null
return oe(this.target,t,this.forceServer,!1,this.getImportRuleTag)},r.prototype.getTagForId=function(e){var t=this.tagMap[e]
if(void 0!==t&&!t.sealed)return t
var n=this.tags[this.tags.length-1]
return this.capacity-=1,0===this.capacity&&(this.capacity=ce,n=this.makeTag(n),this.tags.push(n)),this.tagMap[e]=n},r.prototype.hasId=function(e){return void 0!==this.tagMap[e]},r.prototype.hasNameForId=function(e,t){if(void 0===this.ignoreRehydratedNames[e]&&this.rehydratedNames[t])return!0
var n=this.tagMap[e]
...
this.getTagForId(e).insertMarker(e),this.deferred[e]=t}},r.prototype.inject=function(e,t,n){for(var r=this.clones,a=0;a<r.length;a+=1)r[a].inject(e,t,n)
var o=this.getTagForId(e)
if(void 0!==this.deferred[e]){var i=this.deferred[e].concat(t)
o.insertRules(e,i,n),this.deferred[e]=void 0}else o.insertRules(e,t,n)},r.prototype.remove=function(e){var t=this.tagMap[e]
...
return Object(d.cloneElement)(e.toElement(),{key:n})})},w(r,null,[{key:"master",get:function(){return se||(se=(new r).rehydrate())}},{key:"instance",get:function(){return r.master}}]),r}(),fe=function(e){function t(){return b(this,t),x(this,e.apply(this,arguments))}return E(t,e),t.prototype.getChildContext=function(){var e
return(e={})[W]=this.sheetInstance,e},t.prototype.componentWillMount=function(){if(this.props.sheet)this.sheetInstance=this.props.sheet
else{if(!this.props.target)throw new _(4)
this.sheetInstance=new de(this.props.target)}},t.prototype.render=function(){return c.a.Children.only(this.props.children)},t}(d.Component)
fe.childContextTypes=((ue={})[W]=s.a.oneOfType([s.a.instanceOf(de),s.a.instanceOf(pe)]).isRequired,ue)
var pe=function(){function e(){b(this,e),this.masterSheet=de.master,this.instance=this.masterSheet.clone(),this.closed=!1}return e.prototype.complete=function(){if(!this.closed){var e=this.masterSheet.clones.indexOf(this.instance)
this.masterSheet.clones.splice(e,1),this.closed=!0}},e.prototype.collectStyles=function(e){if(this.closed)throw new _(2)
...
return e.theme&&!r?e.theme:t},me=/[[\].#*$><+~=|^:(),"'`-]+/g,ve=/(^-|-$)/g
function ge(e){return e.replace(me,"-").replace(ve,"")}function ye(e){return e.displayName||e.name||"Component"}function be(e){return"string"==typeof e}
...
var Ee,Ce,xe="__styled-components__",_e=xe+"next__",ke=s.a.shape({getTheme:s.a.func,subscribe:s.a.func,unsubscribe:s.a.func}),Te=((Ee={})[xe]=s.a.func,Ee[_e]=ke,Ee)
var Me,Re=function(t){function n(){b(this,n)
var e=x(this,t.call(this))
return e.unsubscribeToOuterId=-1,e.getTheme=e.getTheme.bind(e),e}return E(n,t),n.prototype.componentWillMount=function(){var e,r,n,a,t=this,o=this.context[_e]
void 0!==o&&(this.unsubscribeToOuterId=o.subscribe(function(e){t.outerTheme=e,void 0!==t.broadcast&&t.publish(t.props.theme)})),this.broadcast=(e=this.getTheme(),r={},n=0,a=e,{publish:function(e){for(var t in a=e,r){var n=r[t]
void 0!==n&&n(a)}},subscribe:function(e){var t=n
return r[t]=e,n+=1,e(a),t},unsubscribe:function(e){r[e]=void 0}})},n.prototype.getChildContext=function(){var e,n=this
return S({},this.context,((e={})[_e]={getTheme:this.getTheme,subscribe:this.broadcast.subscribe,unsubscribe:this.broadcast.unsubscribe},e[xe]=function(e){var t=n.broadcast.subscribe(e)
return function(){return n.broadcast.unsubscribe(t)}},e))},n.prototype.componentWillReceiveProps=function(e){this.props.theme!==e.theme&&this.publish(e.theme)},n.prototype.componentWillUnmount=function(){-1!==this.unsubscribeToOuterId&&this.context[_e].unsubscribe(this.unsubscribeToOuterId)},n.prototype.getTheme=function(e){var t=e||this.props.theme
if("function"==typeof t)return t(this.outerTheme)
if(null===t||Array.isArray(t)||"object"!==(void 0===t?"undefined":h(t)))throw new _(8)
return S({},this.outerTheme,t)},n.prototype.publish=function(e){this.broadcast.publish(this.getTheme(e))},n.prototype.render=function(){return this.props.children?c.a.Children.only(this.props.children):null},n}(d.Component)
Re.childContextTypes=Te,Re.contextTypes=((Ce={})[_e]=ke,Ce)
var Ne={},Ie=S({},Te,((Me={})[W]=s.a.oneOfType([s.a.instanceOf(de),s.a.instanceOf(pe)]),Me)),Oe={}
var Ae=function(o){function i(){var e,t
b(this,i)
for(var n=arguments.length,r=Array(n),a=0;a<n;a++)r[a]=arguments[a]
return(e=t=x(this,o.call.apply(o,[this].concat(r)))).attrs={},t.state={theme:null,generatedClassName:""},t.unsubscribeId=-1,x(t,e)}return E(i,o),i.prototype.unsubscribeFromContext=function(){-1!==this.unsubscribeId&&this.context[_e].unsubscribe(this.unsubscribeId)},i.prototype.buildExecutionContext=function(e,t){var r=this.constructor.attrs,a=S({},t,{theme:e})
return void 0===r?a:(this.attrs=Object.keys(r).reduce(function(e,t){var n=r[t]
return e[t]="function"!=typeof n||function(e,t){for(var n=e;n;)if((n=Object.getPrototypeOf(n))&&n===t)return!0
return!1}(n,d.Component)?n:n(a),e},{}),S({},a,this.attrs))},i.prototype.generateAndInjectStyles=function(e,t){var n=this.constructor,r=n.attrs,a=n.componentStyle,o=(n.warnTooManyClasses,this.context[W]||de.master)
if(a.isStatic&&void 0===r)return a.generateAndInjectStyles(Ne,o)
var i=this.buildExecutionContext(e,t)
return a.generateAndInjectStyles(i,o)},i.prototype.componentWillMount=function(){var r=this,e=this.constructor.componentStyle,t=this.context[_e]
if(e.isStatic){var n=this.generateAndInjectStyles(Ne,this.props)
this.setState({generatedClassName:n})}else if(void 0!==t){var a=t.subscribe
this.unsubscribeId=a(function(e){var t=he(r.props,e,r.constructor.defaultProps),n=r.generateAndInjectStyles(t,r.props)
r.setState({theme:t,generatedClassName:n})})}else{var o=this.props.theme||B,i=this.generateAndInjectStyles(o,this.props)
this.setState({theme:o,generatedClassName:i})}},i.prototype.componentWillReceiveProps=function(n){var r=this
this.constructor.componentStyle.isStatic||this.setState(function(e){var t=he(n,e.theme,r.constructor.defaultProps)
return{theme:t,generatedClassName:r.generateAndInjectStyles(t,n)}})},i.prototype.componentWillUnmount=function(){this.unsubscribeFromContext()},i.prototype.render=function(){var e=this.props.innerRef,t=this.state.generatedClassName,n=this.constructor,r=n.styledComponentId,a=n.target,o=be(a),i=[this.props.className,r,this.attrs.className,t].filter(Boolean).join(" "),c=S({},this.attrs,{className:i})
O(a)?c.innerRef=e:c.ref=e
var u,l=c,s=void 0
for(s in this.props)"innerRef"===s||"className"===s||o&&(u=s,!we.test(u)&&!Se(u.toLowerCase()))||(l[s]="style"===s&&s in this.attrs?S({},this.attrs[s],this.props[s]):this.props[s])
return Object(d.createElement)(a,l)},i}(d.Component)
function Pe(e){for(var t,n=0|e.length,r=0|n,a=0;4<=n;)t=1540483477*(65535&(t=255&e.charCodeAt(a)|(255&e.charCodeAt(++a))<<8|(255&e.charCodeAt(++a))<<16|(255&e.charCodeAt(++a))<<24))+((1540483477*(t>>>16)&65535)<<16),r=1540483477*(65535&r)+((1540483477*(r>>>16)&65535)<<16)^(t=1540483477*(65535&(t^=t>>>24))+((1540483477*(t>>>16)&65535)<<16)),n-=4,++a
switch(n){case 3:r^=(255&e.charCodeAt(a+2))<<16
case 2:r^=(255&e.charCodeAt(a+1))<<8
case 1:r=1540483477*(65535&(r^=255&e.charCodeAt(a)))+((1540483477*(r>>>16)&65535)<<16)}return r=1540483477*(65535&(r^=r>>>13))+((1540483477*(r>>>16)&65535)<<16),(r^=r>>>15)>>>0}var je=H,Le=t.hot&&!1,De=["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2",
"h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul",
"var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","tspan"],Be=function(t){var e="function"==typeof t&&!(t.prototype&&"isReactComponent"in t.prototype),n=O(t)||e,r=function(o){function i(){var e,t
b(this,i)
for(var n=arguments.length,r=Array(n),a=0;a<n;a++)r[a]=arguments[a]
return(e=t=x(this,o.call.apply(o,[this].concat(r)))).state=B,t.unsubscribeId=-1,x(t,e)}return E(i,o),i.prototype.componentWillMount=function(){var n=this,r=this.constructor.defaultProps,e=this.context[_e],t=he(this.props,void 0,r)
if(void 0===e&&void 0!==t)this.setState({theme:t})
else{var a=e.subscribe
this.unsubscribeId=a(function(e){var t=he(n.props,e,r)
n.setState({theme:t})})}},i.prototype.componentWillReceiveProps=function(t){var n=this.constructor.defaultProps
this.setState(function(e){return{theme:he(t,e.theme,n)}})},i.prototype.componentWillUnmount=function(){-1!==this.unsubscribeId&&this.context[_e].unsubscribe(this.unsubscribeId)},i.prototype.render=function(){var e=S({theme:this.state.theme},this.props)
return n||(e.ref=e.innerRef,delete e.innerRef),c.a.createElement(t,e)},i}(c.a.Component)
return r.contextTypes=Te,r.displayName="WithTheme("+ye(t)+")",r.styledComponentId="withTheme",y()(r,t)},Fe={StyleSheet:de}
var Ue,qe,We,He,ze,Ve,Ye,Ze,Je,Xe,Ge,Ke,Qe,$e,et,tt=(Ue=j,qe=v,We=I,He=function(e){return Ue(Pe(e))},function(){function a(e,t,n){if(b(this,a),this.rules=e,this.isStatic=!Le&&function e(t,n){for(var r=0,a=t.length;r<a;r+=1){var o=t[r]
if(Array.isArray(o)&&!e(o))return!1
if("function"==typeof o&&!O(o))return!1}if(void 0!==n)for(var i in n)if("function"==typeof n[i])return!1
return!0}(e,t),this.componentId=n,!de.master.hasId(n)){var r=[]
de.master.deferredInject(n,r)}}return a.prototype.generateAndInjectStyles=function(e,t){var n=this.isStatic,r=this.componentId,a=this.lastClassName
if(je&&n&&void 0!==a&&t.hasNameForId(r,a))return a
var o=qe(this.rules,e),i=He(this.componentId+o.join(""))
return t.hasNameForId(r,i)||t.inject(this.componentId,We(o,"."+i),i),this.lastClassName=i},a.generateName=function(e){return He(e)},a}()),nt=(ze=F,function t(n,r){var a=2<arguments.length&&void 0!==arguments[2]?arguments[2]:B
if(!Object(p.isValidElementType)(r))throw new _(1,String(r))
var e=function(){return n(r,a,ze.apply(void 0,arguments))}
return e.withConfig=function(e){return t(n,r,S({},a,e))},e.attrs=function(e){return t(n,r,S({},a,{attrs:S({},a.attrs||B,e)}))},e}),rt=(Ve=tt,Ye=nt,function i(c,u,l){var e,t=u.isClass,n=void 0===t?!be(c):t,r=u.displayName,a=void 0===r?be(e=c)?"styled."+e:"Styled("+ye(e)+")":r,o=u.componentId,s=void 0===o?function(e,t,n){var r="string"!=typeof t?"sc":ge(t),a=(Oe[r]||0)+1
Oe[r]=a
var o=r+"-"+e.generateName(r+a)
return void 0!==n?n+"-"+o:o}(Ve,u.displayName,u.parentComponentId):o,d=u.ParentComponent,f=void 0===d?Ae:d,p=u.rules,h=u.attrs,m=u.displayName&&u.componentId?ge(u.displayName)+"-"+u.componentId:u.componentId||s,v=new Ve(void 0===p?l:p.concat(l),h,m),g=function(e){function o(){return b(this,o),x(this,e.apply(this,arguments))}return E(o,e),o.withComponent=function(e){var t=u.componentId,n=C(u,["componentId"]),r=t&&t+"-"+(be(e)?e:ge(ye(e))),a=S({},n,{componentId:r,ParentComponent:o})
return i(e,a,l)},w(o,null,[{key:"extend",get:function(){var e=u.rules,t=u.componentId,n=C(u,["rules","componentId"]),r=void 0===e?l:e.concat(l),a=S({},n,{rules:r,parentComponentId:t,ParentComponent:o})
return Ye(i,c,a)}}]),o}(f)
return g.attrs=h,g.componentStyle=v,g.contextTypes=Ie,g.displayName=a,g.styledComponentId=m,g.target=c,n&&y()(g,c,{attrs:!0,componentStyle:!0,displayName:!0,extend:!0,styledComponentId:!0,target:!0,warnTooManyClasses:!0,withComponent:!0}),g}),at=(Ze=j,Je=I,Xe=F,function(){var e=de.master,t=Xe.apply(void 0,arguments),n=Ze(Pe(JSON.stringify(t).replace(/\s|\\n/g,""))),r="sc-keyframes-"+n
return e.hasNameForId(r,n)||e.inject(r,Je(t,n,"@keyframes"),n),n}),ot=(Ge=I,Ke=F,function(){var e=de.master,t=Ke.apply(void 0,arguments),n="sc-global-"+Pe(JSON.stringify(t))
e.hasId(n)||e.inject(n,Ge(t))}),it=(Qe=rt,$e=nt,et=function(e){return $e(Qe,e)},De.forEach(function(e){et[e]=et(e)}),et)
ct.default=it}.call(this,ut("8oxB"),ut("3UD+")(e))},vRqJ:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:o,t=1<arguments.length?arguments[1]:void 0,n=t.type,r=t.payload
...
function h(e,t,n){var r,a=t.prototype;(r=e.prototype=Object.create(a)).constructor=e,r._super=a,n&&i(r,n)}function y(e,t){return function(){return e.apply(t,arguments)}}function b(e,t){return typeof e==n?e.apply(t&&t[0]||m,t):e}function w(e,t){return e===m?t:e}function S(t,e,n){d(_(e),function(e){t.addEventListener(e,n,!1)})}function E(t,e,n){d(_(e),function(e){t.removeEventListener(e,n,!1)})}function C(e,t){for(;e;){if(e==t)return!0
e=e.parentNode}return!1}function x(e,t){return-1<e.indexOf(t)}function _(e){return e.trim().split(/\s+/g)}function k(e,t,n){if(e.indexOf&&!n)return e.indexOf(t)
...
return t.defaultView||t.parentWindow||o}var O="ontouchstart"in o,A=R(o,"PointerEvent")!==m,P=O&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),j="touch",L=25,D=1,B=4,F=8,U=1,q=2,W=4,H=8,z=16,V=q|W,Y=H|z,Z=V|Y,J=["x","y"],X=["clientX","clientY"]
...
if(t.eventType!=F&&(L<c||i.velocity===m)){var u=t.deltaX-i.deltaX,l=t.deltaY-i.deltaY,s=ee(c,u,l)
...
return{x:l(n/t),y:l(r/t)}}function ee(e,t,n){return{x:t/e||0,y:n/e||0}}function te(e,t){return e===t?U:v(e)>=v(t)?e<0?q:W:t<0?H:z}function ne(e,t,n){n||(n=J)
var r=t[n[0]]-e[n[0]],a=t[n[1]]-e[n[1]]
return Math.sqrt(r*r+a*a)}function re(e,t,n){n||(n=J)
var r=t[n[0]]-e[n[0]],a=t[n[1]]-e[n[1]]
return 180*Math.atan2(a,r)/Math.PI}G.prototype={handler:function(){},init:function(){this.evEl&&S(this.element,this.evEl,this.domHandler),this.evTarget&&S(this.target,this.evTarget,this.domHandler),this.evWin&&S(I(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&E(this.element,this.evEl,this.domHandler),this.evTarget&&E(this.target,this.evTarget,this.domHandler),this.evWin&&E(I(this.element),this.evWin,this.domHandler)}}
...
var ue={pointerdown:D,pointermove:2,pointerup:B,pointercancel:F,pointerout:F},le={2:j,3:"pen",4:"mouse",5:"kinect"},se="pointerdown",de="pointermove pointerup pointercancel"
...
a&D&&(0===e.button||i)?c<0&&(t.push(e),c=t.length-1):a&(B|F)&&(n=!0),c<0||(t[c]=e,this.callback(this.manager,a,{pointers:t,changedPointers:[e],pointerType:o,srcEvent:e}),n&&t.splice(c,1))}})
...
a=0
for(;a<i.length;)r[i[a].identifier]&&c.push(i[a]),t&(B|F)&&delete r[i[a].identifier],a++
...
if(!(a&&n.sourceCapabilities&&n.sourceCapabilities.firesTouchEvents)){if(r)(function(e,t){e&D?(this.primaryTouch=t.changedPointers[0].identifier,we.call(this,t)):e&(B|F)&&we.call(this,t)}).call(this,t,n)
...
var Se=R(t.style,"touchAction"),Ee=Se!==m,Ce="manipulation",xe="none",_e="pan-x",ke="pan-y",Te=function(){if(!Ee)return!1
...
return d(this.manager.recognizers,function(e){b(e.options.enable,[e])&&(t=t.concat(e.getTouchAction()))}),function(e){if(x(e,xe))return xe
var t=x(e,_e),n=x(e,ke)
if(t&&n)return xe
if(t||n)return t?_e:ke
if(x(e,Ce))return Ce
return"auto"}(t.join(" "))},preventDefaults:function(e){var t=e.srcEvent,n=e.offsetDirection
if(this.manager.session.prevented)t.preventDefault()
else{var r=this.actions,a=x(r,xe)&&!Te.none,o=x(r,ke)&&!Te[ke],i=x(r,_e)&&!Te[_e]
...
var Re=1
function Ne(e){this.options=i({},this.defaults,e||{}),this.id=N++,this.manager=null,this.options.enable=w(this.options.enable,!0),this.state=Re,this.simultaneous={},this.requireFail=[]}function Ie(e){return 16&e?"cancel":8&e?"end":4&e?"move":2&e?"start":""}function Oe(e){return e==z?"down":e==H?"up":e==q?"left":e==W?"right":""}function Ae(e,t){var n=t.manager
return n?n.get(e):e}function Pe(){Ne.apply(this,arguments)}function je(){Pe.apply(this,arguments),this.pX=null,this.pY=null}function Le(){Pe.apply(this,arguments)}function De(){Ne.apply(this,arguments),this._timer=null,this._input=null}function Be(){Pe.apply(this,arguments)}function Fe(){Pe.apply(this,arguments)}function Ue(){Ne.apply(this,arguments),this.pTime=!1,this.pCenter=!1,this._timer=null,this._input=null,this.count=0}function qe(e,t){return(t=t||{}).recognizers=w(t.recognizers,qe.defaults.preset),
...
return t[(e=Ae(e,this)).id]||(t[e.id]=e).recognizeWith(this),this},dropRecognizeWith:function(e){return r(e,"dropRecognizeWith",this)||(e=Ae(e,this),delete this.simultaneous[e.id]),this},requireFailure:function(e){if(r(e,"requireFailure",this))return this
var t=this.requireFail
return-1===k(t,e=Ae(e,this))&&(t.push(e),e.requireFailure(this)),this},dropRequireFailure:function(e){if(r(e,"dropRequireFailure",this))return this
e=Ae(e,this)
...
function r(e){n.manager.emit(e,t)}e<8&&r(n.options.event+Ie(e)),r(n.options.event),t.additionalEvent&&r(t.additionalEvent),8<=e&&r(n.options.event+Ie(e))},tryEmit:function(e){if(this.canEmit())return this.emit(e)
...
56&this.state&&(this.state=Re),this.state=this.process(t),30&this.state&&this.tryEmit(t)},process:function(e){},getTouchAction:function(){},reset:function(){}},h(Pe,Ne,{defaults:{pointers:1},attrTest:function(e){var t=this.options.pointers
return 0===t||e.pointers.length===t},process:function(e){var t=this.state,n=e.eventType,r=6&t,a=this.attrTest(e)
return r&&(n&F||!a)?16|t:r||a?n&B?8|t:2&t?4|t:2:32}}),h(je,Pe,{defaults:{event:"pan",threshold:10,pointers:1,direction:Z},getTouchAction:function(){var e=this.options.direction,t=[]
return e&V&&t.push(ke),e&Y&&t.push(_e),t},directionTest:function(e){var t=this.options,n=!0,r=e.distance,a=e.direction,o=e.deltaX,i=e.deltaY
return a&t.direction||(r=t.direction&V?(a=0===o?U:o<0?q:W,n=o!=this.pX,Math.abs(e.deltaX)):(a=0===i?U:i<0?H:z,n=i!=this.pY,Math.abs(e.deltaY))),e.direction=a,n&&r>t.threshold&&a&t.direction},attrTest:function(e){return Pe.prototype.attrTest.call(this,e)&&(2&this.state||!(2&this.state)&&this.directionTest(e))},emit:function(e){this.pX=e.deltaX,this.pY=e.deltaY
var t=Oe(e.direction)
t&&(e.additionalEvent=this.options.event+t),this._super.emit.call(this,e)}}),h(Le,Pe,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return[xe]},attrTest:function(e){return this._super.attrTest.call(this,e)&&(Math.abs(e.scale-1)>this.options.threshold||2&this.state)},emit:function(e){if(1!==e.scale){var t=e.scale<1?"in":"out"
...
return 32},reset:function(){clearTimeout(this._timer)},emit:function(e){8===this.state&&(e&&e.eventType&B?this.manager.emit(this.options.event+"up",e):(this._input.timeStamp=g(),this.manager.emit(this.options.event,this._input)))}}),h(Be,Pe,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return[xe]},attrTest:function(e){return this._super.attrTest.call(this,e)&&(Math.abs(e.rotation)>this.options.threshold||2&this.state)}}),h(Fe,Pe,{defaults:{event:"swipe",threshold:10,
...
return n&(V|Y)?t=e.overallVelocity:n&V?t=e.overallVelocityX:n&Y&&(t=e.overallVelocityY),this._super.attrTest.call(this,e)&&n&e.offsetDirection&&e.distance>this.options.threshold&&e.maxPointers==this.options.pointers&&v(t)>this.options.velocity&&e.eventType&B},emit:function(e){var t=Oe(e.offsetDirection)
t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)}}),h(Ue,Ne,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return[Ce]},process:function(e){var t=this.options,n=e.pointers.length===t.pointers,r=e.distance<t.threshold,a=e.deltaTime<t.time
...
qe.VERSION="2.0.7",qe.defaults={domEvents:!1,touchAction:"compute",enable:!0,inputTarget:null,inputClass:null,preset:[[Be,{enable:!1}],[Le,{enable:!1},["rotate"]],[Fe,{direction:V}],[je,{direction:V},["swipe"]],[Ue],[Ue,{event:"doubletap",taps:2},["tap"]],[De]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}}
function We(e,t){var n
this.options=i({},qe.defaults,t||{}),this.options.inputTarget=this.options.inputTarget||e,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=e,this.input=new((n=this).options.inputClass||(A?fe:P?ge:O?be:ce))(n,K),this.touchAction=new Me(this,this.options.touchAction),He(this,!0),d(this.options.recognizers,function(e){var t=this.add(new e[0](e[1]))
...
return d(_(e),function(e){t?n[e]&&n[e].splice(k(n[e],t),1):delete n[e]}),this}},emit:function(e,t){var n,r,a
...
for(var i=0;i<o.length;)o[i](t),i++}},destroy:function(){this.element&&He(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null}},i(qe,{INPUT_START:D,INPUT_MOVE:2,INPUT_END:B,INPUT_CANCEL:F,STATE_POSSIBLE:Re,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:U,DIRECTION_LEFT:q,DIRECTION_RIGHT:W,DIRECTION_UP:H,DIRECTION_DOWN:z,DIRECTION_HORIZONTAL:V,DIRECTION_VERTICAL:Y,DIRECTION_ALL:Z,Manager:We,Input:G,TouchAction:Me,
TouchInput:ge,MouseInput:ce,PointerEventInput:fe,TouchMouseInput:be,SingleTouchInput:he,Recognizer:Ne,AttrRecognizer:Pe,Tap:Ue,Pan:je,Swipe:Fe,Pinch:Le,Rotate:Be,Press:De,on:S,off:E,each:d,merge:p,extend:f,assign:i,inherit:h,bindFn:y,prefixed:R}),(void 0!==o?o:"undefined"!=typeof self?self:{}).Hammer=qe,(Ze=function(){return qe}.call(Ve,Ye,Ve,ze))===m||(ze.exports=Ze)}(window,document)},yOnP:function(e,t,n){"use strict"
var r=n("TqRt")
...
,"bold"]}]}},z6R5:function(e,t,n){"use strict"
e.exports=n("62JN")},zAG7:function(e,t,n){"use strict"
...
t.getFontSize=p
t.getWidgetStyle=function(t){var e,n,r,a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",o=t.inspectables(),i={},c={top:(r=t).top,left:r.left,width:r.w(),height:r.height,right:r.left+r.w(),bottom:r.top+r.height}
if(" "!=t.zoomable&&(e=c.width,n=c.height,"mtooltip"==t.name&&("top"==t.tt_placement||"bottom"==t.tt_placement?n-=t.tt_arrow_size:e-=t.tt_arrow_size),i.width=e,i.height=n),"mtooltip"==t.name){var u=["top","right","bottom","left"].map(function(e){return e===t.tt_placement?t.tt_arrow_size+"px":0})
i.margin=u.join(" ")}"pg"==t.name&&a||(i.left=c.left,t.primary_fixed&&a?(i.position="fixed",t.primary_fixed===Widget.FIXED_TYPE.bottom?i.bottom=t.cs().height-c.bottom:i.top=c.top):i.top=c.top),i.zIndex=t.z,t.tc&&-1!=o.indexOf("tc")&&(i.color=t.tc),t.bg&&-1!=o.indexOf("bg")&&(i.backgroundColor=t.bg),t.bc&&-1!=o.indexOf("bc")&&(i.borderColor=t.bc),-1!=o.indexOf("box_shadow")&&t.box_shadow&&"line"!==t.name&&(i.boxShadow=h(JSON.parse(t.box_shadow))),-1!=o.indexOf("text_shadow")&&t.text_shadow?i.textShadow=m(
...
t.ani_delay&&"0"!=t.ani_delay&&(i.animationDelay=t.ani_delay),i.animationIterationCount=t.ani_count,t.ani_duration&&"0"!=t.ani_duration&&(i.animationDuration=t.ani_duration)),l=t.v?-1!=o.indexOf("o")?t.o/100:"":a?0:.4,!t.v&&a&&(s="none"),""!==l&&(i.opacity=l),s&&(i.pointerEvents=s),t.transition&&(i.transition=t.transition),i}
...
var x=(0,g.connect)(function(e){var t=e.container,n=t.layers,r=n.activeLayerID,a=n.visibilityScreenID,o=n.resourceByScreen,i=t.previewSetting,c=e.model,u=c.current,l=u.screenCid,s=u.projectCid,d=c.projects,f=i.isSelectLayer,p=k(d,s).device,h=T(f,o,a,r),m=_(o,a,p)
return(0,v.default)({},i,{layer:h},m,{screenCid:l})})(C)
t.default=x
var _=(0,S.immutableTransformCache)(function(e,t,n){var r=[],a=[],o=[],i=[],c=e[t]
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var a=r(n("yTJ9")),o=r(n("knB1")),i=r(n("QkVN")),c=window,u=c.confirm,l=c.alert,s=c.MB,d=c.MBLocale,f=c.I18N,p=c.Team,h=c.Project,m=c.Combo,v=c.Template,g=c.Screen,y=c.Screenstate,b=c.Widget,w=c.Widgetstate,S=c.Panel,E=c.Panelstate,C=c.Link,x=c.Collaborator,_=c.Comment,k=c.CommentThread,T=c.Asset
"zh-CN"===d&&(0,i.default)(a.default.settings.strings,o.default)
var M={MBLocale:d,parseTimeAgo:function(e){return(0,a.default)(e)}},R={Team:p,Project:h,Combo:m,Template:v,Screen:g,Screenstate:y,Widget:b,Widgetstate:w,Panel:S,Panelstate:E,Link:C,Collaborator:x,Comment:_,CommentThread:k,Asset:T,requestCid:function(){return(0<arguments.length&&void 0!==arguments[0]?arguments[0]:"")+Math.uuid(10,16)+Date.now()},queueSave:function(){return s.AutoSaver&&s.AutoSaver.triggerSave()}},N={Global:window,Storage:s.localStorageDelegate,confirm:function(){return u.apply(void 0,
arguments)},alert:function(){return l.apply(void 0,arguments)},MB:s,I18N:f,L10N:M,SpineModel:R}
t.default=N}}])

//# sourceMappingURL=lib-preview-235fc7c34450ad6c88e2.js.map